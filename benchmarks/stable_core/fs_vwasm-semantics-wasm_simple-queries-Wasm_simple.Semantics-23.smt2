...
(assert (! (forall ((@x0 Term)) (! (= (Valid (Prims.hasEq (Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x0))) (Valid (Prims.hasEq Prims.nat))) :pattern ((Valid (Prims.hasEq (Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x0)))) :qid haseqTm_refine_c1424615841f28cac7fc34e92b7ff33c)) :named haseqTm_refine_c1424615841f28cac7fc34e92b7ff33c))
(assert (! (forall ((@x0 Term)) (! (= (Words_s.natN @x0) (Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x0)) :pattern ((Words_s.natN @x0)) :qid equation_Words_s.natN)) :named equation_Words_s.natN))
...
(assert (! (= Words_s.nat32 (Words_s.natN (BoxInt 4294967296))) :named equation_Words_s.nat32))
...
(assert (! (= Wasm_simple.Semantics.var Words_s.nat32) :named equation_Wasm_simple.Semantics.var))
...
(assert (! (Valid (Prims.hasEq Wasm_simple.Semantics.literal)) :named assumption_Wasm_simple.Semantics.literal__uu___haseq))
...
(declare-fun Wasm_simple.Semantics.uu___is_F32 (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_F32@tok () Term)
(declare-fun Tm_refine_b8c219242eafc02809ce480ee811cb16 () Term)
(declare-fun Wasm_simple.Semantics.__proj__F32__item___0 (Term) Term)
(declare-fun Tm_arrow_29f42c04885e8fa24d5472f21f2be2e3 () Term)
(declare-fun Wasm_simple.Semantics.__proj__F32__item___0@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_F64 (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_F64@tok () Term)
(declare-fun Tm_refine_4cadca0c93e4fca017fb394aaa09c7de () Term)
(declare-fun Wasm_simple.Semantics.__proj__F64__item___0 (Term) Term)
(declare-fun Tm_arrow_4d72ae2af52b082e1fd83e896294b4a1 () Term)
(declare-fun Wasm_simple.Semantics.__proj__F64__item___0@tok () Term)
(declare-fun Wasm_simple.Semantics.name () Term)
(declare-fun Wasm_simple.Semantics.value_type () Term)
(declare-fun Wasm_simple.Semantics.I32Ty () Term)
(declare-fun Wasm_simple.Semantics.I32Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Ty () Term)
(declare-fun Wasm_simple.Semantics.I64Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Ty () Term)
(declare-fun Wasm_simple.Semantics.F32Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Ty () Term)
(declare-fun Wasm_simple.Semantics.F64Ty@tok () Term)
(define-fun is-Wasm_simple.Semantics.value_type ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 233) (= __@x0 Wasm_simple.Semantics.value_type)))
(define-fun is-Wasm_simple.Semantics.I32Ty ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 239) (= __@x0 Wasm_simple.Semantics.I32Ty)))
(define-fun is-Wasm_simple.Semantics.I64Ty ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 241) (= __@x0 Wasm_simple.Semantics.I64Ty)))
(define-fun is-Wasm_simple.Semantics.F32Ty ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 243) (= __@x0 Wasm_simple.Semantics.F32Ty)))
(define-fun is-Wasm_simple.Semantics.F64Ty ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 245) (= __@x0 Wasm_simple.Semantics.F64Ty)))
(declare-fun Wasm_simple.Semantics.uu___is_I32Ty (Term) Term)
(declare-fun Tm_arrow_47062824950cdd0d9e205c71658d92e7 () Term)
(declare-fun Wasm_simple.Semantics.uu___is_I32Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_I64Ty (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_I64Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_F32Ty (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_F32Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_F64Ty (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_F64Ty@tok () Term)
(declare-fun Wasm_simple.Semantics.func_type () Term)
(declare-fun Wasm_simple.Semantics.pack_size () Term)
(declare-fun Tm_refine_52d8b90eecdfc1e33886adeb748d8e10 () Term)
(declare-fun Wasm_simple.Semantics.loadop () Term)
(declare-fun Wasm_simple.Semantics.Mkloadop (Term Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.Mkloadop_lty (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkloadop_loffset (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkloadop_lsz (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkloadop_lsigned (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkloadop@tok () Term)
(declare-fun Tm_arrow_51dbfca76ea5a099defdb7290f660d05 () Term)
(define-fun is-Wasm_simple.Semantics.loadop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 275) (= __@x0 Wasm_simple.Semantics.loadop)))
(define-fun is-Wasm_simple.Semantics.Mkloadop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 281) (= __@x0 (Wasm_simple.Semantics.Mkloadop (Wasm_simple.Semantics.Mkloadop_lty __@x0) (Wasm_simple.Semantics.Mkloadop_loffset __@x0) (Wasm_simple.Semantics.Mkloadop_lsz __@x0) (Wasm_simple.Semantics.Mkloadop_lsigned __@x0)))))
(assert (! (Valid (Prims.hasEq Wasm_simple.Semantics.loadop)) :named assumption_Wasm_simple.Semantics.loadop__uu___haseq))
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lty (Term) Term)
(declare-fun Tm_arrow_91a4411b18c4eced8b2266bf3f0cad5e () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lty@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__loffset (Term) Term)
(declare-fun Tm_arrow_0c635861200dce71ec3ae324fb4a5abe () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__loffset@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lsz (Term) Term)
(declare-fun Tm_arrow_8224a5a87f1d6033625a4422ded12ab3 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lsz@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lsigned (Term) Term)
(declare-fun Tm_arrow_03dbb00bc683969b3c536918b22af43a () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkloadop__item__lsigned@tok () Term)
(declare-fun Wasm_simple.Semantics.storeop () Term)
(declare-fun Wasm_simple.Semantics.Mkstoreop (Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.Mkstoreop_sty (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkstoreop_soffset (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkstoreop_ssz (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkstoreop@tok () Term)
(declare-fun Tm_arrow_f518459233f541b4fe6e0b10ca57c0d2 () Term)
(define-fun is-Wasm_simple.Semantics.storeop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 313) (= __@x0 Wasm_simple.Semantics.storeop)))
(define-fun is-Wasm_simple.Semantics.Mkstoreop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 319) (= __@x0 (Wasm_simple.Semantics.Mkstoreop (Wasm_simple.Semantics.Mkstoreop_sty __@x0) (Wasm_simple.Semantics.Mkstoreop_soffset __@x0) (Wasm_simple.Semantics.Mkstoreop_ssz __@x0)))))
(assert (! (Valid (Prims.hasEq Wasm_simple.Semantics.storeop)) :named assumption_Wasm_simple.Semantics.storeop__uu___haseq))
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__sty (Term) Term)
(declare-fun Tm_arrow_3ce897ffb8efa2ec71ee8cf77cd2bae8 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__sty@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__soffset (Term) Term)
(declare-fun Tm_arrow_c51f3948ecc871892f807c55414cedf6 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__soffset@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__ssz (Term) Term)
(declare-fun Tm_arrow_0642db9421591ebe01fdf29c25b6c69f () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkstoreop__item__ssz@tok () Term)
(declare-fun Wasm_simple.Semantics.brtable_type () Term)
(declare-fun Wasm_simple.Semantics.Mkbrtable_type (Term Term) Term)
(declare-fun Wasm_simple.Semantics.Mkbrtable_type_cases (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkbrtable_type_def (Term) Term)
(declare-fun Wasm_simple.Semantics.Mkbrtable_type@tok () Term)
(declare-fun Tm_arrow_463fc4c7de28967f537f6f7f5f3dc5ef () Term)
(define-fun is-Wasm_simple.Semantics.brtable_type ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 349) (= __@x0 Wasm_simple.Semantics.brtable_type)))
(define-fun is-Wasm_simple.Semantics.Mkbrtable_type ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 355) (= __@x0 (Wasm_simple.Semantics.Mkbrtable_type (Wasm_simple.Semantics.Mkbrtable_type_cases __@x0) (Wasm_simple.Semantics.Mkbrtable_type_def __@x0)))))
(declare-fun Wasm_simple.Semantics.__proj__Mkbrtable_type__item__cases (Term) Term)
(declare-fun Tm_arrow_7dc6b97df6d23a2ba8cca3af08ae13a2 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkbrtable_type__item__cases@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkbrtable_type__item__def (Term) Term)
(declare-fun Tm_arrow_ab09b7a54f6161726199561bcef9ff1f () Term)
(declare-fun Wasm_simple.Semantics.__proj__Mkbrtable_type__item__def@tok () Term)
(declare-fun Wasm_simple.Semantics.jcond () Term)
(declare-fun Wasm_simple.Semantics.Always () Term)
(declare-fun Wasm_simple.Semantics.Always@tok () Term)
(declare-fun Wasm_simple.Semantics.IsNonZero () Term)
(declare-fun Wasm_simple.Semantics.IsNonZero@tok () Term)
(define-fun is-Wasm_simple.Semantics.jcond ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 381) (= __@x0 Wasm_simple.Semantics.jcond)))
(define-fun is-Wasm_simple.Semantics.Always ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 387) (= __@x0 Wasm_simple.Semantics.Always)))
(define-fun is-Wasm_simple.Semantics.IsNonZero ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 389) (= __@x0 Wasm_simple.Semantics.IsNonZero)))
(declare-fun Wasm_simple.Semantics.uu___is_Always (Term) Term)
(declare-fun Tm_arrow_955ef8bd09d5b45acc0101fcc706975f () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Always@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_IsNonZero (Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_IsNonZero@tok () Term)
(declare-fun Wasm_simple.Semantics.precode (Term) Term)
(declare-fun Wasm_simple.Semantics.precode@x0 (Term) Term)
(declare-fun Wasm_simple.Semantics.precode@tok () Term)
(declare-fun Wasm_simple.Semantics.Ins (Term Term) Term)
(declare-fun Wasm_simple.Semantics.Ins_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Ins_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Ins@tok () Term)
(declare-fun Wasm_simple.Semantics.Block (Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.Block_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Block_block (Term) Term)
(declare-fun Wasm_simple.Semantics.Block_ts (Term) Term)
(declare-fun Wasm_simple.Semantics.Block@tok () Term)
(declare-fun Wasm_simple.Semantics.IfElse (Term Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.IfElse_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.IfElse_ifTrue (Term) Term)
(declare-fun Wasm_simple.Semantics.IfElse_ifFalse (Term) Term)
(declare-fun Wasm_simple.Semantics.IfElse_ts (Term) Term)
(declare-fun Wasm_simple.Semantics.IfElse@tok () Term)
(declare-fun Wasm_simple.Semantics.Break (Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.Break_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Break_level (Term) Term)
(declare-fun Wasm_simple.Semantics.Break_cond (Term) Term)
(declare-fun Wasm_simple.Semantics.Break@tok () Term)
(declare-fun Wasm_simple.Semantics.BrTable (Term Term) Term)
(declare-fun Wasm_simple.Semantics.BrTable_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.BrTable_tbl (Term) Term)
(declare-fun Wasm_simple.Semantics.BrTable@tok () Term)
(declare-fun Wasm_simple.Semantics.Continue (Term Term Term) Term)
(declare-fun Wasm_simple.Semantics.Continue_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Continue_level (Term) Term)
(declare-fun Wasm_simple.Semantics.Continue_cond (Term) Term)
(declare-fun Wasm_simple.Semantics.Continue@tok () Term)
(declare-fun Wasm_simple.Semantics.Call (Term Term) Term)
(declare-fun Wasm_simple.Semantics.Call_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Call_f (Term) Term)
(declare-fun Wasm_simple.Semantics.Call@tok () Term)
(declare-fun Wasm_simple.Semantics.ExternCall (Term Term) Term)
(declare-fun Wasm_simple.Semantics.ExternCall_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternCall_f (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternCall@tok () Term)
(declare-fun Wasm_simple.Semantics.CallIndirect (Term Term) Term)
(declare-fun Wasm_simple.Semantics.CallIndirect_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.CallIndirect_fn_ty (Term) Term)
(declare-fun Wasm_simple.Semantics.CallIndirect@tok () Term)
(declare-fun Wasm_simple.Semantics.Return (Term) Term)
(declare-fun Wasm_simple.Semantics.Return_t_ins (Term) Term)
(declare-fun Wasm_simple.Semantics.Return@tok () Term)
(declare-fun Tm_arrow_ab4a4770c1895036075e9e5c47dc9680 () Term)
(declare-fun Tm_arrow_7f2e1354df6fdc4d18d32e7466ac9db3 () Term)
(declare-fun Tm_arrow_78afa23794fbf5c9edf3e2396ec4ba69 () Term)
(declare-fun Tm_arrow_633276433aec9b8d06e60fb79b993ef5 () Term)
(declare-fun Tm_arrow_40cf431f379283ef5ad71e1d48694259 () Term)
(declare-fun Tm_arrow_74245b477e619be09fa3cd96fba98673 () Term)
(declare-fun Tm_arrow_c80aa1b0bf9f20cb4382505992ecabec () Term)
(define-fun is-Wasm_simple.Semantics.precode ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 506) (exists ((@x0 Term)) (! (= __@x0 (Wasm_simple.Semantics.precode @x0)) :qid is-Wasm_simple.Semantics.precode))))
(define-fun is-Wasm_simple.Semantics.Ins ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 513) (= __@x0 (Wasm_simple.Semantics.Ins (Wasm_simple.Semantics.Ins_t_ins __@x0) (Wasm_simple.Semantics.Ins_ins __@x0)))))
(define-fun is-Wasm_simple.Semantics.Block ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 518) (= __@x0 (Wasm_simple.Semantics.Block (Wasm_simple.Semantics.Block_t_ins __@x0) (Wasm_simple.Semantics.Block_block __@x0) (Wasm_simple.Semantics.Block_ts __@x0)))))
(define-fun is-Wasm_simple.Semantics.IfElse ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 523) (= __@x0 (Wasm_simple.Semantics.IfElse (Wasm_simple.Semantics.IfElse_t_ins __@x0) (Wasm_simple.Semantics.IfElse_ifTrue __@x0) (Wasm_simple.Semantics.IfElse_ifFalse __@x0) (Wasm_simple.Semantics.IfElse_ts __@x0)))))
(define-fun is-Wasm_simple.Semantics.Break ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 528) (= __@x0 (Wasm_simple.Semantics.Break (Wasm_simple.Semantics.Break_t_ins __@x0) (Wasm_simple.Semantics.Break_level __@x0) (Wasm_simple.Semantics.Break_cond __@x0)))))
(define-fun is-Wasm_simple.Semantics.BrTable ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 533) (= __@x0 (Wasm_simple.Semantics.BrTable (Wasm_simple.Semantics.BrTable_t_ins __@x0) (Wasm_simple.Semantics.BrTable_tbl __@x0)))))
(define-fun is-Wasm_simple.Semantics.Continue ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 538) (= __@x0 (Wasm_simple.Semantics.Continue (Wasm_simple.Semantics.Continue_t_ins __@x0) (Wasm_simple.Semantics.Continue_level __@x0) (Wasm_simple.Semantics.Continue_cond __@x0)))))
(define-fun is-Wasm_simple.Semantics.Call ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 543) (= __@x0 (Wasm_simple.Semantics.Call (Wasm_simple.Semantics.Call_t_ins __@x0) (Wasm_simple.Semantics.Call_f __@x0)))))
(define-fun is-Wasm_simple.Semantics.ExternCall ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 548) (= __@x0 (Wasm_simple.Semantics.ExternCall (Wasm_simple.Semantics.ExternCall_t_ins __@x0) (Wasm_simple.Semantics.ExternCall_f __@x0)))))
(define-fun is-Wasm_simple.Semantics.CallIndirect ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 553) (= __@x0 (Wasm_simple.Semantics.CallIndirect (Wasm_simple.Semantics.CallIndirect_t_ins __@x0) (Wasm_simple.Semantics.CallIndirect_fn_ty __@x0)))))
(define-fun is-Wasm_simple.Semantics.Return ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 558) (= __@x0 (Wasm_simple.Semantics.Return (Wasm_simple.Semantics.Return_t_ins __@x0)))))
(declare-fun Wasm_simple.Semantics.uu___is_Ins (Term Term) Term)
(declare-fun Tm_arrow_047adbd4a6dc156f178bff9b50ae7adf () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Ins@tok () Term)
(declare-fun Tm_refine_3a0d386b00bbb1f2fd1a200399bfe5c2 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__Ins__item__ins (Term Term) Term)
(declare-fun Tm_arrow_0726129e680ce00ec9f653ed3d225e25 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Ins__item__ins@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Block (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_Block@tok () Term)
(declare-fun Tm_refine_879fe9b53517338495d16bb7d26bbf7b (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__Block__item__block (Term Term) Term)
(declare-fun Tm_arrow_484e6f22c115fec591d4703e91d5d3cd () Term)
(declare-fun Wasm_simple.Semantics.__proj__Block__item__block@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Block__item__ts (Term Term) Term)
(declare-fun Tm_arrow_76882c70cd2db343d8482e987c55be81 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Block__item__ts@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_IfElse (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_IfElse@tok () Term)
(declare-fun Tm_refine_ee9b38029a4f21be481347a17098f334 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ifTrue (Term Term) Term)
(declare-fun Tm_arrow_371e8289c01d67453dcad7a7d88cdd15 () Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ifTrue@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ifFalse (Term Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ifFalse@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ts (Term Term) Term)
(declare-fun Tm_arrow_3156834dfd2692c9e14a761165db7864 () Term)
(declare-fun Wasm_simple.Semantics.__proj__IfElse__item__ts@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Break (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_Break@tok () Term)
(declare-fun Tm_refine_67ff2ed0468bab01df80d3e2f3062cc0 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__Break__item__level (Term Term) Term)
(declare-fun Tm_arrow_8edaf6524354efbd262e7292cc04c9f9 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Break__item__level@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Break__item__cond (Term Term) Term)
(declare-fun Tm_arrow_0ee963aa4082e6843f1475f5ec378061 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Break__item__cond@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_BrTable (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_BrTable@tok () Term)
(declare-fun Tm_refine_d9fe72f19963eb190537bd0cd4c8478b (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__BrTable__item__tbl (Term Term) Term)
(declare-fun Tm_arrow_6f7f80d3ed471902b8e9ebec017da12b () Term)
(declare-fun Wasm_simple.Semantics.__proj__BrTable__item__tbl@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Continue (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_Continue@tok () Term)
(declare-fun Tm_refine_7b2fbafa151eee188a6926d26cd60c87 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__Continue__item__level (Term Term) Term)
(declare-fun Tm_arrow_631e660064f57c2dc953f1ec371ec590 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Continue__item__level@tok () Term)
(declare-fun Wasm_simple.Semantics.__proj__Continue__item__cond (Term Term) Term)
(declare-fun Tm_arrow_338925cbc973314bcb3ee0204bc4f82b () Term)
(declare-fun Wasm_simple.Semantics.__proj__Continue__item__cond@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Call (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_Call@tok () Term)
(declare-fun Tm_refine_348e2b8658779c110c5a13d121191228 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__Call__item__f (Term Term) Term)
(declare-fun Tm_arrow_af275b115116597ae883bba08fc2e789 () Term)
(declare-fun Wasm_simple.Semantics.__proj__Call__item__f@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_ExternCall (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_ExternCall@tok () Term)
(declare-fun Tm_refine_cdf76edeb540b5468b2a43d703e8c30f (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__ExternCall__item__f (Term Term) Term)
(declare-fun Tm_arrow_113bdaf6f442e23d174e920c2382cc67 () Term)
(declare-fun Wasm_simple.Semantics.__proj__ExternCall__item__f@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_CallIndirect (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_CallIndirect@tok () Term)
(declare-fun Tm_refine_6f21047fbcdf9a7f3842ea9cd1bb6760 (Term) Term)
(declare-fun Wasm_simple.Semantics.__proj__CallIndirect__item__fn_ty (Term Term) Term)
(declare-fun Tm_arrow_fdd44b75a49b0f9e9f7510ed38da92eb () Term)
(declare-fun Wasm_simple.Semantics.__proj__CallIndirect__item__fn_ty@tok () Term)
(declare-fun Wasm_simple.Semantics.uu___is_Return (Term Term) Term)
(declare-fun Wasm_simple.Semantics.uu___is_Return@tok () Term)
(push)
(push)
(declare-fun Wasm_simple.Semantics.ins () Term)
(declare-fun Wasm_simple.Semantics.Unreachable () Term)
(declare-fun Wasm_simple.Semantics.Unreachable@tok () Term)
(declare-fun Wasm_simple.Semantics.DropI () Term)
(declare-fun Wasm_simple.Semantics.DropI@tok () Term)
(declare-fun Wasm_simple.Semantics.DropF () Term)
(declare-fun Wasm_simple.Semantics.DropF@tok () Term)
(declare-fun Wasm_simple.Semantics.SelectI () Term)
(declare-fun Wasm_simple.Semantics.SelectI@tok () Term)
(declare-fun Wasm_simple.Semantics.SelectF () Term)
(declare-fun Wasm_simple.Semantics.SelectF@tok () Term)
(declare-fun Wasm_simple.Semantics.LocalGet (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalGet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalGet@tok () Term)
(declare-fun Wasm_simple.Semantics.LocalSet (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalSet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalSet@tok () Term)
(declare-fun Wasm_simple.Semantics.LocalTee (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalTee__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.LocalTee@tok () Term)
(declare-fun Wasm_simple.Semantics.GlobalGet (Term) Term)
(declare-fun Wasm_simple.Semantics.GlobalGet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.GlobalGet@tok () Term)
(declare-fun Wasm_simple.Semantics.GlobalSet (Term) Term)
(declare-fun Wasm_simple.Semantics.GlobalSet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.GlobalSet@tok () Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalGet (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalGet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalGet@tok () Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalSet (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalSet__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.ExternGlobalSet@tok () Term)
(declare-fun Wasm_simple.Semantics.Load (Term) Term)
(declare-fun Wasm_simple.Semantics.Load__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.Load@tok () Term)
(declare-fun Wasm_simple.Semantics.Store (Term) Term)
(declare-fun Wasm_simple.Semantics.Store__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.Store@tok () Term)
(declare-fun Wasm_simple.Semantics.MemorySize () Term)
(declare-fun Wasm_simple.Semantics.MemorySize@tok () Term)
(declare-fun Wasm_simple.Semantics.MemoryGrow () Term)
(declare-fun Wasm_simple.Semantics.MemoryGrow@tok () Term)
(declare-fun Wasm_simple.Semantics.Const (Term) Term)
(declare-fun Wasm_simple.Semantics.Const__0 (Term) Term)
(declare-fun Wasm_simple.Semantics.Const@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Eqz () Term)
(declare-fun Wasm_simple.Semantics.I32Eqz@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Eqz () Term)
(declare-fun Wasm_simple.Semantics.I64Eqz@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Eq () Term)
(declare-fun Wasm_simple.Semantics.I32Eq@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Ne () Term)
(declare-fun Wasm_simple.Semantics.I32Ne@tok () Term)
(declare-fun Wasm_simple.Semantics.I32LtS () Term)
(declare-fun Wasm_simple.Semantics.I32LtS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32LtU () Term)
(declare-fun Wasm_simple.Semantics.I32LtU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32GtS () Term)
(declare-fun Wasm_simple.Semantics.I32GtS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32GtU () Term)
(declare-fun Wasm_simple.Semantics.I32GtU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32LeS () Term)
(declare-fun Wasm_simple.Semantics.I32LeS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32LeU () Term)
(declare-fun Wasm_simple.Semantics.I32LeU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32GeS () Term)
(declare-fun Wasm_simple.Semantics.I32GeS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32GeU () Term)
(declare-fun Wasm_simple.Semantics.I32GeU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Eq () Term)
(declare-fun Wasm_simple.Semantics.I64Eq@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Ne () Term)
(declare-fun Wasm_simple.Semantics.I64Ne@tok () Term)
(declare-fun Wasm_simple.Semantics.I64LtS () Term)
(declare-fun Wasm_simple.Semantics.I64LtS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64LtU () Term)
(declare-fun Wasm_simple.Semantics.I64LtU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64GtS () Term)
(declare-fun Wasm_simple.Semantics.I64GtS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64GtU () Term)
(declare-fun Wasm_simple.Semantics.I64GtU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64LeS () Term)
(declare-fun Wasm_simple.Semantics.I64LeS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64LeU () Term)
(declare-fun Wasm_simple.Semantics.I64LeU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64GeS () Term)
(declare-fun Wasm_simple.Semantics.I64GeS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64GeU () Term)
(declare-fun Wasm_simple.Semantics.I64GeU@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Eq () Term)
(declare-fun Wasm_simple.Semantics.F32Eq@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Ne () Term)
(declare-fun Wasm_simple.Semantics.F32Ne@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Lt () Term)
(declare-fun Wasm_simple.Semantics.F32Lt@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Gt () Term)
(declare-fun Wasm_simple.Semantics.F32Gt@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Le () Term)
(declare-fun Wasm_simple.Semantics.F32Le@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Ge () Term)
(declare-fun Wasm_simple.Semantics.F32Ge@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Eq () Term)
(declare-fun Wasm_simple.Semantics.F64Eq@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Ne () Term)
(declare-fun Wasm_simple.Semantics.F64Ne@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Lt () Term)
(declare-fun Wasm_simple.Semantics.F64Lt@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Gt () Term)
(declare-fun Wasm_simple.Semantics.F64Gt@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Le () Term)
(declare-fun Wasm_simple.Semantics.F64Le@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Ge () Term)
(declare-fun Wasm_simple.Semantics.F64Ge@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Clz () Term)
(declare-fun Wasm_simple.Semantics.I32Clz@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Ctz () Term)
(declare-fun Wasm_simple.Semantics.I32Ctz@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Popcnt () Term)
(declare-fun Wasm_simple.Semantics.I32Popcnt@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Clz () Term)
(declare-fun Wasm_simple.Semantics.I64Clz@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Ctz () Term)
(declare-fun Wasm_simple.Semantics.I64Ctz@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Popcnt () Term)
(declare-fun Wasm_simple.Semantics.I64Popcnt@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Neg () Term)
(declare-fun Wasm_simple.Semantics.F32Neg@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Abs () Term)
(declare-fun Wasm_simple.Semantics.F32Abs@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Ceil () Term)
(declare-fun Wasm_simple.Semantics.F32Ceil@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Floor () Term)
(declare-fun Wasm_simple.Semantics.F32Floor@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Trunc () Term)
(declare-fun Wasm_simple.Semantics.F32Trunc@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Nearest () Term)
(declare-fun Wasm_simple.Semantics.F32Nearest@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Sqrt () Term)
(declare-fun Wasm_simple.Semantics.F32Sqrt@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Neg () Term)
(declare-fun Wasm_simple.Semantics.F64Neg@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Abs () Term)
(declare-fun Wasm_simple.Semantics.F64Abs@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Ceil () Term)
(declare-fun Wasm_simple.Semantics.F64Ceil@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Floor () Term)
(declare-fun Wasm_simple.Semantics.F64Floor@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Trunc () Term)
(declare-fun Wasm_simple.Semantics.F64Trunc@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Nearest () Term)
(declare-fun Wasm_simple.Semantics.F64Nearest@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Sqrt () Term)
(declare-fun Wasm_simple.Semantics.F64Sqrt@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Add () Term)
(declare-fun Wasm_simple.Semantics.I32Add@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Sub () Term)
(declare-fun Wasm_simple.Semantics.I32Sub@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Mul () Term)
(declare-fun Wasm_simple.Semantics.I32Mul@tok () Term)
(declare-fun Wasm_simple.Semantics.I32DivS () Term)
(declare-fun Wasm_simple.Semantics.I32DivS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32DivU () Term)
(declare-fun Wasm_simple.Semantics.I32DivU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32RemS () Term)
(declare-fun Wasm_simple.Semantics.I32RemS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32RemU () Term)
(declare-fun Wasm_simple.Semantics.I32RemU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32And () Term)
(declare-fun Wasm_simple.Semantics.I32And@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Or () Term)
(declare-fun Wasm_simple.Semantics.I32Or@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Xor () Term)
(declare-fun Wasm_simple.Semantics.I32Xor@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Shl () Term)
(declare-fun Wasm_simple.Semantics.I32Shl@tok () Term)
(declare-fun Wasm_simple.Semantics.I32ShrS () Term)
(declare-fun Wasm_simple.Semantics.I32ShrS@tok () Term)
(declare-fun Wasm_simple.Semantics.I32ShrU () Term)
(declare-fun Wasm_simple.Semantics.I32ShrU@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Rotl () Term)
(declare-fun Wasm_simple.Semantics.I32Rotl@tok () Term)
(declare-fun Wasm_simple.Semantics.I32Rotr () Term)
(declare-fun Wasm_simple.Semantics.I32Rotr@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Add () Term)
(declare-fun Wasm_simple.Semantics.I64Add@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Sub () Term)
(declare-fun Wasm_simple.Semantics.I64Sub@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Mul () Term)
(declare-fun Wasm_simple.Semantics.I64Mul@tok () Term)
(declare-fun Wasm_simple.Semantics.I64DivS () Term)
(declare-fun Wasm_simple.Semantics.I64DivS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64DivU () Term)
(declare-fun Wasm_simple.Semantics.I64DivU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64RemS () Term)
(declare-fun Wasm_simple.Semantics.I64RemS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64RemU () Term)
(declare-fun Wasm_simple.Semantics.I64RemU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64And () Term)
(declare-fun Wasm_simple.Semantics.I64And@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Or () Term)
(declare-fun Wasm_simple.Semantics.I64Or@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Xor () Term)
(declare-fun Wasm_simple.Semantics.I64Xor@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Shl () Term)
(declare-fun Wasm_simple.Semantics.I64Shl@tok () Term)
(declare-fun Wasm_simple.Semantics.I64ShrS () Term)
(declare-fun Wasm_simple.Semantics.I64ShrS@tok () Term)
(declare-fun Wasm_simple.Semantics.I64ShrU () Term)
(declare-fun Wasm_simple.Semantics.I64ShrU@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Rotl () Term)
(declare-fun Wasm_simple.Semantics.I64Rotl@tok () Term)
(declare-fun Wasm_simple.Semantics.I64Rotr () Term)
(declare-fun Wasm_simple.Semantics.I64Rotr@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Add () Term)
(declare-fun Wasm_simple.Semantics.F32Add@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Sub () Term)
(declare-fun Wasm_simple.Semantics.F32Sub@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Mul () Term)
(declare-fun Wasm_simple.Semantics.F32Mul@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Div () Term)
(declare-fun Wasm_simple.Semantics.F32Div@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Min () Term)
(declare-fun Wasm_simple.Semantics.F32Min@tok () Term)
(declare-fun Wasm_simple.Semantics.F32Max () Term)
(declare-fun Wasm_simple.Semantics.F32Max@tok () Term)
(declare-fun Wasm_simple.Semantics.F32CopySign () Term)
(declare-fun Wasm_simple.Semantics.F32CopySign@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Add () Term)
(declare-fun Wasm_simple.Semantics.F64Add@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Sub () Term)
(declare-fun Wasm_simple.Semantics.F64Sub@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Mul () Term)
(declare-fun Wasm_simple.Semantics.F64Mul@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Div () Term)
(declare-fun Wasm_simple.Semantics.F64Div@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Min () Term)
(declare-fun Wasm_simple.Semantics.F64Min@tok () Term)
(declare-fun Wasm_simple.Semantics.F64Max () Term)
(declare-fun Wasm_simple.Semantics.F64Max@tok () Term)
(declare-fun Wasm_simple.Semantics.F64CopySign () Term)
(declare-fun Wasm_simple.Semantics.F64CopySign@tok () Term)
(declare-fun Wasm_simple.Semantics.I32WrapI64 () Term)
(declare-fun Wasm_simple.Semantics.I32WrapI64@tok () Term)
(declare-fun Wasm_simple.Semantics.I32TruncSF32 () Term)
(declare-fun Wasm_simple.Semantics.I32TruncSF32@tok () Term)
(declare-fun Wasm_simple.Semantics.I32TruncUF32 () Term)
(declare-fun Wasm_simple.Semantics.I32TruncUF32@tok () Term)
(declare-fun Wasm_simple.Semantics.I32TruncSF64 () Term)
(declare-fun Wasm_simple.Semantics.I32TruncSF64@tok () Term)
(declare-fun Wasm_simple.Semantics.I32TruncUF64 () Term)
(declare-fun Wasm_simple.Semantics.I32TruncUF64@tok () Term)
(declare-fun Wasm_simple.Semantics.I32ReinterpretFloat () Term)
(declare-fun Wasm_simple.Semantics.I32ReinterpretFloat@tok () Term)
(declare-fun Wasm_simple.Semantics.I64ExtendSI32 () Term)
(declare-fun Wasm_simple.Semantics.I64ExtendSI32@tok () Term)
(declare-fun Wasm_simple.Semantics.I64ExtendUI32 () Term)
(declare-fun Wasm_simple.Semantics.I64ExtendUI32@tok () Term)
(declare-fun Wasm_simple.Semantics.I64TruncSF32 () Term)
(declare-fun Wasm_simple.Semantics.I64TruncSF32@tok () Term)
(declare-fun Wasm_simple.Semantics.I64TruncUF32 () Term)
(declare-fun Wasm_simple.Semantics.I64TruncUF32@tok () Term)
(declare-fun Wasm_simple.Semantics.I64TruncSF64 () Term)
(declare-fun Wasm_simple.Semantics.I64TruncSF64@tok () Term)
(declare-fun Wasm_simple.Semantics.I64TruncUF64 () Term)
(declare-fun Wasm_simple.Semantics.I64TruncUF64@tok () Term)
(declare-fun Wasm_simple.Semantics.I64ReinterpretFloat () Term)
(declare-fun Wasm_simple.Semantics.I64ReinterpretFloat@tok () Term)
(declare-fun Wasm_simple.Semantics.F32DemoteF64 () Term)
(declare-fun Wasm_simple.Semantics.F32DemoteF64@tok () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertSI32 () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertSI32@tok () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertUI32 () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertUI32@tok () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertSI64 () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertSI64@tok () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertUI64 () Term)
(declare-fun Wasm_simple.Semantics.F32ConvertUI64@tok () Term)
(declare-fun Wasm_simple.Semantics.F32ReinterpretInt () Term)
(declare-fun Wasm_simple.Semantics.F32ReinterpretInt@tok () Term)
(declare-fun Wasm_simple.Semantics.F64PromoteF32 () Term)
(declare-fun Wasm_simple.Semantics.F64PromoteF32@tok () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertSI32 () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertSI32@tok () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertUI32 () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertUI32@tok () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertSI64 () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertSI64@tok () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertUI64 () Term)
(declare-fun Wasm_simple.Semantics.F64ConvertUI64@tok () Term)
(declare-fun Wasm_simple.Semantics.F64ReinterpretInt () Term)
(declare-fun Wasm_simple.Semantics.F64ReinterpretInt@tok () Term)
(declare-fun Tm_arrow_af4f56f98b4ddb76e4e2c55cc5ced6c9 () Term)
(declare-fun Tm_arrow_16502fcd006b3838f3f2c3bb9c6135d5 () Term)
(declare-fun Tm_arrow_224b9def62e7b8210de1c5c1f1f26177 () Term)
(declare-fun Tm_arrow_bd4a4858e4857f9e28851fd370b13c30 () Term)
(define-fun is-Wasm_simple.Semantics.ins ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 967) (= __@x0 Wasm_simple.Semantics.ins)))
(define-fun is-Wasm_simple.Semantics.Unreachable ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 973) (= __@x0 Wasm_simple.Semantics.Unreachable)))
(define-fun is-Wasm_simple.Semantics.DropI ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 975) (= __@x0 Wasm_simple.Semantics.DropI)))
(define-fun is-Wasm_simple.Semantics.DropF ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 977) (= __@x0 Wasm_simple.Semantics.DropF)))
(define-fun is-Wasm_simple.Semantics.SelectI ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 979) (= __@x0 Wasm_simple.Semantics.SelectI)))
(define-fun is-Wasm_simple.Semantics.SelectF ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 981) (= __@x0 Wasm_simple.Semantics.SelectF)))
(define-fun is-Wasm_simple.Semantics.LocalGet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 983) (= __@x0 (Wasm_simple.Semantics.LocalGet (Wasm_simple.Semantics.LocalGet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.LocalSet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 988) (= __@x0 (Wasm_simple.Semantics.LocalSet (Wasm_simple.Semantics.LocalSet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.LocalTee ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 993) (= __@x0 (Wasm_simple.Semantics.LocalTee (Wasm_simple.Semantics.LocalTee__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.GlobalGet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 998) (= __@x0 (Wasm_simple.Semantics.GlobalGet (Wasm_simple.Semantics.GlobalGet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.GlobalSet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1003) (= __@x0 (Wasm_simple.Semantics.GlobalSet (Wasm_simple.Semantics.GlobalSet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.ExternGlobalGet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1008) (= __@x0 (Wasm_simple.Semantics.ExternGlobalGet (Wasm_simple.Semantics.ExternGlobalGet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.ExternGlobalSet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1013) (= __@x0 (Wasm_simple.Semantics.ExternGlobalSet (Wasm_simple.Semantics.ExternGlobalSet__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.Load ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1018) (= __@x0 (Wasm_simple.Semantics.Load (Wasm_simple.Semantics.Load__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.Store ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1023) (= __@x0 (Wasm_simple.Semantics.Store (Wasm_simple.Semantics.Store__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.MemorySize ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1028) (= __@x0 Wasm_simple.Semantics.MemorySize)))
(define-fun is-Wasm_simple.Semantics.MemoryGrow ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1030) (= __@x0 Wasm_simple.Semantics.MemoryGrow)))
(define-fun is-Wasm_simple.Semantics.Const ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1032) (= __@x0 (Wasm_simple.Semantics.Const (Wasm_simple.Semantics.Const__0 __@x0)))))
(define-fun is-Wasm_simple.Semantics.I32Eqz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1037) (= __@x0 Wasm_simple.Semantics.I32Eqz)))
(define-fun is-Wasm_simple.Semantics.I64Eqz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1039) (= __@x0 Wasm_simple.Semantics.I64Eqz)))
(define-fun is-Wasm_simple.Semantics.I32Eq ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1041) (= __@x0 Wasm_simple.Semantics.I32Eq)))
(define-fun is-Wasm_simple.Semantics.I32Ne ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1043) (= __@x0 Wasm_simple.Semantics.I32Ne)))
(define-fun is-Wasm_simple.Semantics.I32LtS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1045) (= __@x0 Wasm_simple.Semantics.I32LtS)))
(define-fun is-Wasm_simple.Semantics.I32LtU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1047) (= __@x0 Wasm_simple.Semantics.I32LtU)))
(define-fun is-Wasm_simple.Semantics.I32GtS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1049) (= __@x0 Wasm_simple.Semantics.I32GtS)))
(define-fun is-Wasm_simple.Semantics.I32GtU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1051) (= __@x0 Wasm_simple.Semantics.I32GtU)))
(define-fun is-Wasm_simple.Semantics.I32LeS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1053) (= __@x0 Wasm_simple.Semantics.I32LeS)))
(define-fun is-Wasm_simple.Semantics.I32LeU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1055) (= __@x0 Wasm_simple.Semantics.I32LeU)))
(define-fun is-Wasm_simple.Semantics.I32GeS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1057) (= __@x0 Wasm_simple.Semantics.I32GeS)))
(define-fun is-Wasm_simple.Semantics.I32GeU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1059) (= __@x0 Wasm_simple.Semantics.I32GeU)))
(define-fun is-Wasm_simple.Semantics.I64Eq ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1061) (= __@x0 Wasm_simple.Semantics.I64Eq)))
(define-fun is-Wasm_simple.Semantics.I64Ne ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1063) (= __@x0 Wasm_simple.Semantics.I64Ne)))
(define-fun is-Wasm_simple.Semantics.I64LtS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1065) (= __@x0 Wasm_simple.Semantics.I64LtS)))
(define-fun is-Wasm_simple.Semantics.I64LtU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1067) (= __@x0 Wasm_simple.Semantics.I64LtU)))
(define-fun is-Wasm_simple.Semantics.I64GtS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1069) (= __@x0 Wasm_simple.Semantics.I64GtS)))
(define-fun is-Wasm_simple.Semantics.I64GtU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1071) (= __@x0 Wasm_simple.Semantics.I64GtU)))
(define-fun is-Wasm_simple.Semantics.I64LeS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1073) (= __@x0 Wasm_simple.Semantics.I64LeS)))
(define-fun is-Wasm_simple.Semantics.I64LeU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1075) (= __@x0 Wasm_simple.Semantics.I64LeU)))
(define-fun is-Wasm_simple.Semantics.I64GeS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1077) (= __@x0 Wasm_simple.Semantics.I64GeS)))
(define-fun is-Wasm_simple.Semantics.I64GeU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1079) (= __@x0 Wasm_simple.Semantics.I64GeU)))
(define-fun is-Wasm_simple.Semantics.F32Eq ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1081) (= __@x0 Wasm_simple.Semantics.F32Eq)))
(define-fun is-Wasm_simple.Semantics.F32Ne ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1083) (= __@x0 Wasm_simple.Semantics.F32Ne)))
(define-fun is-Wasm_simple.Semantics.F32Lt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1085) (= __@x0 Wasm_simple.Semantics.F32Lt)))
(define-fun is-Wasm_simple.Semantics.F32Gt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1087) (= __@x0 Wasm_simple.Semantics.F32Gt)))
(define-fun is-Wasm_simple.Semantics.F32Le ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1089) (= __@x0 Wasm_simple.Semantics.F32Le)))
(define-fun is-Wasm_simple.Semantics.F32Ge ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1091) (= __@x0 Wasm_simple.Semantics.F32Ge)))
(define-fun is-Wasm_simple.Semantics.F64Eq ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1093) (= __@x0 Wasm_simple.Semantics.F64Eq)))
(define-fun is-Wasm_simple.Semantics.F64Ne ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1095) (= __@x0 Wasm_simple.Semantics.F64Ne)))
(define-fun is-Wasm_simple.Semantics.F64Lt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1097) (= __@x0 Wasm_simple.Semantics.F64Lt)))
(define-fun is-Wasm_simple.Semantics.F64Gt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1099) (= __@x0 Wasm_simple.Semantics.F64Gt)))
(define-fun is-Wasm_simple.Semantics.F64Le ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1101) (= __@x0 Wasm_simple.Semantics.F64Le)))
(define-fun is-Wasm_simple.Semantics.F64Ge ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1103) (= __@x0 Wasm_simple.Semantics.F64Ge)))
(define-fun is-Wasm_simple.Semantics.I32Clz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1105) (= __@x0 Wasm_simple.Semantics.I32Clz)))
(define-fun is-Wasm_simple.Semantics.I32Ctz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1107) (= __@x0 Wasm_simple.Semantics.I32Ctz)))
(define-fun is-Wasm_simple.Semantics.I32Popcnt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1109) (= __@x0 Wasm_simple.Semantics.I32Popcnt)))
(define-fun is-Wasm_simple.Semantics.I64Clz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1111) (= __@x0 Wasm_simple.Semantics.I64Clz)))
(define-fun is-Wasm_simple.Semantics.I64Ctz ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1113) (= __@x0 Wasm_simple.Semantics.I64Ctz)))
(define-fun is-Wasm_simple.Semantics.I64Popcnt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1115) (= __@x0 Wasm_simple.Semantics.I64Popcnt)))
(define-fun is-Wasm_simple.Semantics.F32Neg ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1117) (= __@x0 Wasm_simple.Semantics.F32Neg)))
(define-fun is-Wasm_simple.Semantics.F32Abs ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1119) (= __@x0 Wasm_simple.Semantics.F32Abs)))
(define-fun is-Wasm_simple.Semantics.F32Ceil ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1121) (= __@x0 Wasm_simple.Semantics.F32Ceil)))
(define-fun is-Wasm_simple.Semantics.F32Floor ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1123) (= __@x0 Wasm_simple.Semantics.F32Floor)))
(define-fun is-Wasm_simple.Semantics.F32Trunc ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1125) (= __@x0 Wasm_simple.Semantics.F32Trunc)))
(define-fun is-Wasm_simple.Semantics.F32Nearest ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1127) (= __@x0 Wasm_simple.Semantics.F32Nearest)))
(define-fun is-Wasm_simple.Semantics.F32Sqrt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1129) (= __@x0 Wasm_simple.Semantics.F32Sqrt)))
(define-fun is-Wasm_simple.Semantics.F64Neg ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1131) (= __@x0 Wasm_simple.Semantics.F64Neg)))
(define-fun is-Wasm_simple.Semantics.F64Abs ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1133) (= __@x0 Wasm_simple.Semantics.F64Abs)))
(define-fun is-Wasm_simple.Semantics.F64Ceil ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1135) (= __@x0 Wasm_simple.Semantics.F64Ceil)))
(define-fun is-Wasm_simple.Semantics.F64Floor ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1137) (= __@x0 Wasm_simple.Semantics.F64Floor)))
(define-fun is-Wasm_simple.Semantics.F64Trunc ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1139) (= __@x0 Wasm_simple.Semantics.F64Trunc)))
(define-fun is-Wasm_simple.Semantics.F64Nearest ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1141) (= __@x0 Wasm_simple.Semantics.F64Nearest)))
(define-fun is-Wasm_simple.Semantics.F64Sqrt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1143) (= __@x0 Wasm_simple.Semantics.F64Sqrt)))
(define-fun is-Wasm_simple.Semantics.I32Add ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1145) (= __@x0 Wasm_simple.Semantics.I32Add)))
(define-fun is-Wasm_simple.Semantics.I32Sub ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1147) (= __@x0 Wasm_simple.Semantics.I32Sub)))
(define-fun is-Wasm_simple.Semantics.I32Mul ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1149) (= __@x0 Wasm_simple.Semantics.I32Mul)))
(define-fun is-Wasm_simple.Semantics.I32DivS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1151) (= __@x0 Wasm_simple.Semantics.I32DivS)))
(define-fun is-Wasm_simple.Semantics.I32DivU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1153) (= __@x0 Wasm_simple.Semantics.I32DivU)))
(define-fun is-Wasm_simple.Semantics.I32RemS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1155) (= __@x0 Wasm_simple.Semantics.I32RemS)))
(define-fun is-Wasm_simple.Semantics.I32RemU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1157) (= __@x0 Wasm_simple.Semantics.I32RemU)))
(define-fun is-Wasm_simple.Semantics.I32And ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1159) (= __@x0 Wasm_simple.Semantics.I32And)))
(define-fun is-Wasm_simple.Semantics.I32Or ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1161) (= __@x0 Wasm_simple.Semantics.I32Or)))
(define-fun is-Wasm_simple.Semantics.I32Xor ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1163) (= __@x0 Wasm_simple.Semantics.I32Xor)))
(define-fun is-Wasm_simple.Semantics.I32Shl ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1165) (= __@x0 Wasm_simple.Semantics.I32Shl)))
(define-fun is-Wasm_simple.Semantics.I32ShrS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1167) (= __@x0 Wasm_simple.Semantics.I32ShrS)))
(define-fun is-Wasm_simple.Semantics.I32ShrU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1169) (= __@x0 Wasm_simple.Semantics.I32ShrU)))
(define-fun is-Wasm_simple.Semantics.I32Rotl ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1171) (= __@x0 Wasm_simple.Semantics.I32Rotl)))
(define-fun is-Wasm_simple.Semantics.I32Rotr ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1173) (= __@x0 Wasm_simple.Semantics.I32Rotr)))
(define-fun is-Wasm_simple.Semantics.I64Add ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1175) (= __@x0 Wasm_simple.Semantics.I64Add)))
(define-fun is-Wasm_simple.Semantics.I64Sub ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1177) (= __@x0 Wasm_simple.Semantics.I64Sub)))
(define-fun is-Wasm_simple.Semantics.I64Mul ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1179) (= __@x0 Wasm_simple.Semantics.I64Mul)))
(define-fun is-Wasm_simple.Semantics.I64DivS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1181) (= __@x0 Wasm_simple.Semantics.I64DivS)))
(define-fun is-Wasm_simple.Semantics.I64DivU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1183) (= __@x0 Wasm_simple.Semantics.I64DivU)))
(define-fun is-Wasm_simple.Semantics.I64RemS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1185) (= __@x0 Wasm_simple.Semantics.I64RemS)))
(define-fun is-Wasm_simple.Semantics.I64RemU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1187) (= __@x0 Wasm_simple.Semantics.I64RemU)))
(define-fun is-Wasm_simple.Semantics.I64And ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1189) (= __@x0 Wasm_simple.Semantics.I64And)))
(define-fun is-Wasm_simple.Semantics.I64Or ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1191) (= __@x0 Wasm_simple.Semantics.I64Or)))
(define-fun is-Wasm_simple.Semantics.I64Xor ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1193) (= __@x0 Wasm_simple.Semantics.I64Xor)))
(define-fun is-Wasm_simple.Semantics.I64Shl ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1195) (= __@x0 Wasm_simple.Semantics.I64Shl)))
(define-fun is-Wasm_simple.Semantics.I64ShrS ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1197) (= __@x0 Wasm_simple.Semantics.I64ShrS)))
(define-fun is-Wasm_simple.Semantics.I64ShrU ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1199) (= __@x0 Wasm_simple.Semantics.I64ShrU)))
(define-fun is-Wasm_simple.Semantics.I64Rotl ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1201) (= __@x0 Wasm_simple.Semantics.I64Rotl)))
(define-fun is-Wasm_simple.Semantics.I64Rotr ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1203) (= __@x0 Wasm_simple.Semantics.I64Rotr)))
(define-fun is-Wasm_simple.Semantics.F32Add ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1205) (= __@x0 Wasm_simple.Semantics.F32Add)))
(define-fun is-Wasm_simple.Semantics.F32Sub ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1207) (= __@x0 Wasm_simple.Semantics.F32Sub)))
(define-fun is-Wasm_simple.Semantics.F32Mul ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1209) (= __@x0 Wasm_simple.Semantics.F32Mul)))
(define-fun is-Wasm_simple.Semantics.F32Div ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1211) (= __@x0 Wasm_simple.Semantics.F32Div)))
(define-fun is-Wasm_simple.Semantics.F32Min ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1213) (= __@x0 Wasm_simple.Semantics.F32Min)))
(define-fun is-Wasm_simple.Semantics.F32Max ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1215) (= __@x0 Wasm_simple.Semantics.F32Max)))
(define-fun is-Wasm_simple.Semantics.F32CopySign ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1217) (= __@x0 Wasm_simple.Semantics.F32CopySign)))
(define-fun is-Wasm_simple.Semantics.F64Add ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1219) (= __@x0 Wasm_simple.Semantics.F64Add)))
(define-fun is-Wasm_simple.Semantics.F64Sub ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1221) (= __@x0 Wasm_simple.Semantics.F64Sub)))
(define-fun is-Wasm_simple.Semantics.F64Mul ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1223) (= __@x0 Wasm_simple.Semantics.F64Mul)))
(define-fun is-Wasm_simple.Semantics.F64Div ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1225) (= __@x0 Wasm_simple.Semantics.F64Div)))
(define-fun is-Wasm_simple.Semantics.F64Min ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1227) (= __@x0 Wasm_simple.Semantics.F64Min)))
(define-fun is-Wasm_simple.Semantics.F64Max ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1229) (= __@x0 Wasm_simple.Semantics.F64Max)))
(define-fun is-Wasm_simple.Semantics.F64CopySign ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1231) (= __@x0 Wasm_simple.Semantics.F64CopySign)))
(define-fun is-Wasm_simple.Semantics.I32WrapI64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1233) (= __@x0 Wasm_simple.Semantics.I32WrapI64)))
(define-fun is-Wasm_simple.Semantics.I32TruncSF32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1235) (= __@x0 Wasm_simple.Semantics.I32TruncSF32)))
(define-fun is-Wasm_simple.Semantics.I32TruncUF32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1237) (= __@x0 Wasm_simple.Semantics.I32TruncUF32)))
(define-fun is-Wasm_simple.Semantics.I32TruncSF64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1239) (= __@x0 Wasm_simple.Semantics.I32TruncSF64)))
(define-fun is-Wasm_simple.Semantics.I32TruncUF64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1241) (= __@x0 Wasm_simple.Semantics.I32TruncUF64)))
(define-fun is-Wasm_simple.Semantics.I32ReinterpretFloat ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1243) (= __@x0 Wasm_simple.Semantics.I32ReinterpretFloat)))
(define-fun is-Wasm_simple.Semantics.I64ExtendSI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1245) (= __@x0 Wasm_simple.Semantics.I64ExtendSI32)))
(define-fun is-Wasm_simple.Semantics.I64ExtendUI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1247) (= __@x0 Wasm_simple.Semantics.I64ExtendUI32)))
(define-fun is-Wasm_simple.Semantics.I64TruncSF32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1249) (= __@x0 Wasm_simple.Semantics.I64TruncSF32)))
(define-fun is-Wasm_simple.Semantics.I64TruncUF32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1251) (= __@x0 Wasm_simple.Semantics.I64TruncUF32)))
(define-fun is-Wasm_simple.Semantics.I64TruncSF64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1253) (= __@x0 Wasm_simple.Semantics.I64TruncSF64)))
(define-fun is-Wasm_simple.Semantics.I64TruncUF64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1255) (= __@x0 Wasm_simple.Semantics.I64TruncUF64)))
(define-fun is-Wasm_simple.Semantics.I64ReinterpretFloat ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1257) (= __@x0 Wasm_simple.Semantics.I64ReinterpretFloat)))
(define-fun is-Wasm_simple.Semantics.F32DemoteF64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1259) (= __@x0 Wasm_simple.Semantics.F32DemoteF64)))
(define-fun is-Wasm_simple.Semantics.F32ConvertSI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1261) (= __@x0 Wasm_simple.Semantics.F32ConvertSI32)))
(define-fun is-Wasm_simple.Semantics.F32ConvertUI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1263) (= __@x0 Wasm_simple.Semantics.F32ConvertUI32)))
(define-fun is-Wasm_simple.Semantics.F32ConvertSI64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1265) (= __@x0 Wasm_simple.Semantics.F32ConvertSI64)))
(define-fun is-Wasm_simple.Semantics.F32ConvertUI64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1267) (= __@x0 Wasm_simple.Semantics.F32ConvertUI64)))
(define-fun is-Wasm_simple.Semantics.F32ReinterpretInt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1269) (= __@x0 Wasm_simple.Semantics.F32ReinterpretInt)))
(define-fun is-Wasm_simple.Semantics.F64PromoteF32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1271) (= __@x0 Wasm_simple.Semantics.F64PromoteF32)))
(define-fun is-Wasm_simple.Semantics.F64ConvertSI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1273) (= __@x0 Wasm_simple.Semantics.F64ConvertSI32)))
(define-fun is-Wasm_simple.Semantics.F64ConvertUI32 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1275) (= __@x0 Wasm_simple.Semantics.F64ConvertUI32)))
(define-fun is-Wasm_simple.Semantics.F64ConvertSI64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1277) (= __@x0 Wasm_simple.Semantics.F64ConvertSI64)))
(define-fun is-Wasm_simple.Semantics.F64ConvertUI64 ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1279) (= __@x0 Wasm_simple.Semantics.F64ConvertUI64)))
(define-fun is-Wasm_simple.Semantics.F64ReinterpretInt ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 1281) (= __@x0 Wasm_simple.Semantics.F64ReinterpretInt)))
(push)
...
(assert (! (not (=> (Valid (Prims.hasEq Wasm_simple.Semantics.ins) ) (and (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_45 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_46 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.1)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_47 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.2)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_48 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.3)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_49 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.4)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_50 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.5)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.var) (or label_51 (Valid (Prims.hasEq Wasm_simple.Semantics.var) ) ) ) :qid @query.6)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.loadop) (or label_52 (Valid (Prims.hasEq Wasm_simple.Semantics.loadop) ) ) ) :qid @query.7)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.storeop) (or label_53 (Valid (Prims.hasEq Wasm_simple.Semantics.storeop) ) ) ) :qid @query.8)) (forall ((@x0 Term)) (! (=> (HasType @x0 Wasm_simple.Semantics.literal) (or label_54 (Valid (Prims.hasEq Wasm_simple.Semantics.literal) ) ) ) :qid @query.9)) ) )) :named query))
(check-sat)
