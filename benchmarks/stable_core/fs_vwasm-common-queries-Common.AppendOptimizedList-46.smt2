...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (Prims.eq2 @x0 @x1 @x2) (Prims.squash (Prims.equals @x0 @x1 @x2))) :pattern ((Prims.eq2 @x0 @x1 @x2)) :qid equation_Prims.eq2)) :named equation_Prims.eq2))
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (= @x1 @x2) (Valid (Prims.eq2 @x0 @x1 @x2))) :pattern ((Prims.eq2 @x0 @x1 @x2)) :qid eq2-interp)) :named eq2-interp))
...
(push)
(declare-fun label_204 () Bool)
(declare-fun Tm_refine_af130c7e6b33d86c2e1d93172a8d28e5 (Term Term Term Term Term Term Term) Term)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 Tm_type) (HasType @x2 (Prims.list @x0)) (HasType @x3 (Prims.list @x1)) (HasType @x4 Tm_type) (HasType @x5 Tm_type) (HasType @x6 (Prims.list @x4)) (HasType @x7 (Tm_refine_af130c7e6b33d86c2e1d93172a8d28e5 @x4 @x0 @x6 @x2 @x5 @x1 @x3)) (HasType @x8 (Prims.squash (Prims.eq2 Prims.nat (FStar.List.Tot.Base.length @x4 @x6) (FStar.List.Tot.Base.length @x5 @x7))))) (or label_204 (= (FStar.List.Tot.Base.length @x4 @x6) (FStar.List.Tot.Base.length @x5 @x7)) ) ) :qid @query))) :named query))
(check-sat)
