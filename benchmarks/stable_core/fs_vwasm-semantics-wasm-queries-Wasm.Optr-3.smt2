...
(define-fun is-Wasm.Optr.optr ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 136) (exists ((@x0 Term)) (! (= __@x0 (Wasm.Optr.optr @x0)) :qid is-Wasm.Optr.optr))))
(define-fun is-Wasm.Optr.Left ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 143) (= __@x0 (Wasm.Optr.Left (Wasm.Optr.Left__a __@x0) (Wasm.Optr.Left_v __@x0)))))
(define-fun is-Wasm.Optr.Right ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 148) (= __@x0 (Wasm.Optr.Right (Wasm.Optr.Right__a __@x0) (Wasm.Optr.Right_v __@x0)))))
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term)) (! (=> (HasTypeFuel (SFuel @u0) @x1 (Wasm.Optr.optr @x2)) (or (and (is-Wasm.Optr.Left @x1) (= @x2 (Wasm.Optr.Left__a @x1))) (and (is-Wasm.Optr.Right @x1) (= @x2 (Wasm.Optr.Right__a @x1))))) :pattern ((HasTypeFuel (SFuel @u0) @x1 (Wasm.Optr.optr @x2))) :qid fuel_guarded_inversion_Wasm.Optr.optr)) :named fuel_guarded_inversion_Wasm.Optr.optr))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Wasm.Optr.uu___is_Left @x0 @x1) (BoxBool (is-Wasm.Optr.Left @x1))) :pattern ((Wasm.Optr.uu___is_Left @x0 @x1)) :qid disc_equation_Wasm.Optr.Left)) :named disc_equation_Wasm.Optr.Left))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Wasm.Optr.uu___is_Right @x0 @x1) (BoxBool (is-Wasm.Optr.Right @x1))) :pattern ((Wasm.Optr.uu___is_Right @x0 @x1)) :qid disc_equation_Wasm.Optr.Right)) :named disc_equation_Wasm.Optr.Right))
...
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (Wasm.Optr.optr @x0)) (HasType @x2 @x0) (not (BoxBool_proj_0 (Wasm.Optr.uu___is_Right @x0 @x1)) ) (not (BoxBool_proj_0 (Wasm.Optr.uu___is_Left @x0 @x1)) ) ) label_4) :qid @query))) :named query))
(check-sat)
