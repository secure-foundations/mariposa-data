...
(push)
(declare-fun label_211 () Bool)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x2 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x3 Semantics.Common.CFG.loc) (HasType @x4 (Semantics.Common.CFG.precode @x0 @x1 @x2)) (HasType @x5 (Tm_refine_5af849ab981f90c8372db61456c78ea3 @x0 @x1 @x2 @x3))) (or label_211 (< (BoxInt_proj_0 @x3) (BoxInt_proj_0 (FStar.List.Tot.Base.length (Semantics.Common.CFG.precode @x0 @x1 @x2) @x5))) ) ) :qid @query))) :named query))
(check-sat)
