...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_56b3c9bbc61ccff4870f24da9cd942ae @x2 @x3)) (and (HasTypeFuel @u0 @x1 (Semantics.Common.CFG.Instructions.ins_t @x2 @x3)) (BoxBool_proj_0 (Semantics.Common.CFG.Instructions.uu___is_FTrunc32 @x2 @x3 @x1)) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_56b3c9bbc61ccff4870f24da9cd942ae @x2 @x3))) :qid refinement_interpretation_Tm_refine_56b3c9bbc61ccff4870f24da9cd942ae)) :named refinement_interpretation_Tm_refine_56b3c9bbc61ccff4870f24da9cd942ae))
...
(push)
(declare-fun label_271 () Bool)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x1 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x2 (Tm_refine_56b3c9bbc61ccff4870f24da9cd942ae @x0 @x1)) (not (BoxBool_proj_0 (Semantics.Common.CFG.Instructions.uu___is_FTrunc32 @x0 @x1 @x2)) ) ) label_271) :qid @query))) :named query))
(check-sat)
