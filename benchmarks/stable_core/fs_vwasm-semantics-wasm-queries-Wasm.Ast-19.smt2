...
(define-fun is-Wasm.Ast.memop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 126) (exists ((@x0 Term)) (! (= __@x0 (Wasm.Ast.memop @x0)) :qid is-Wasm.Ast.memop))))
(define-fun is-Wasm.Ast.Mkmemop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 133) (= __@x0 (Wasm.Ast.Mkmemop (Wasm.Ast.Mkmemop__a __@x0) (Wasm.Ast.Mkmemop_ty __@x0) (Wasm.Ast.Mkmemop_align __@x0) (Wasm.Ast.Mkmemop_offset __@x0) (Wasm.Ast.Mkmemop_sz __@x0)))))
...
(define-fun is-Wasm.Ast.instr_ ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 393) (= __@x0 Wasm.Ast.instr_)))
(define-fun is-Wasm.Ast.Unreachable ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 399) (= __@x0 Wasm.Ast.Unreachable)))
(define-fun is-Wasm.Ast.Nop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 401) (= __@x0 Wasm.Ast.Nop)))
(define-fun is-Wasm.Ast.Drop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 403) (= __@x0 Wasm.Ast.Drop)))
(define-fun is-Wasm.Ast.Select ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 405) (= __@x0 Wasm.Ast.Select)))
(define-fun is-Wasm.Ast.Block ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 407) (= __@x0 (Wasm.Ast.Block (Wasm.Ast.Block__0 __@x0)))))
(define-fun is-Wasm.Ast.Loop ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 412) (= __@x0 (Wasm.Ast.Loop (Wasm.Ast.Loop__0 __@x0)))))
(define-fun is-Wasm.Ast.If ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 417) (= __@x0 (Wasm.Ast.If (Wasm.Ast.If__0 __@x0)))))
(define-fun is-Wasm.Ast.Br ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 422) (= __@x0 (Wasm.Ast.Br (Wasm.Ast.Br__0 __@x0)))))
(define-fun is-Wasm.Ast.BrIf ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 427) (= __@x0 (Wasm.Ast.BrIf (Wasm.Ast.BrIf__0 __@x0)))))
(define-fun is-Wasm.Ast.BrTable ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 432) (= __@x0 (Wasm.Ast.BrTable (Wasm.Ast.BrTable__0 __@x0)))))
(define-fun is-Wasm.Ast.Return ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 437) (= __@x0 Wasm.Ast.Return)))
(define-fun is-Wasm.Ast.Call ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 439) (= __@x0 (Wasm.Ast.Call (Wasm.Ast.Call__0 __@x0)))))
(define-fun is-Wasm.Ast.CallIndirect ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 444) (= __@x0 (Wasm.Ast.CallIndirect (Wasm.Ast.CallIndirect__0 __@x0)))))
(define-fun is-Wasm.Ast.LocalGet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 449) (= __@x0 (Wasm.Ast.LocalGet (Wasm.Ast.LocalGet__0 __@x0)))))
(define-fun is-Wasm.Ast.LocalSet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 454) (= __@x0 (Wasm.Ast.LocalSet (Wasm.Ast.LocalSet__0 __@x0)))))
(define-fun is-Wasm.Ast.LocalTee ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 459) (= __@x0 (Wasm.Ast.LocalTee (Wasm.Ast.LocalTee__0 __@x0)))))
(define-fun is-Wasm.Ast.GlobalGet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 464) (= __@x0 (Wasm.Ast.GlobalGet (Wasm.Ast.GlobalGet__0 __@x0)))))
(define-fun is-Wasm.Ast.GlobalSet ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 469) (= __@x0 (Wasm.Ast.GlobalSet (Wasm.Ast.GlobalSet__0 __@x0)))))
(define-fun is-Wasm.Ast.Load ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 474) (= __@x0 (Wasm.Ast.Load (Wasm.Ast.Load__0 __@x0)))))
(define-fun is-Wasm.Ast.Store ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 479) (= __@x0 (Wasm.Ast.Store (Wasm.Ast.Store__0 __@x0)))))
(define-fun is-Wasm.Ast.MemorySize ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 484) (= __@x0 Wasm.Ast.MemorySize)))
(define-fun is-Wasm.Ast.MemoryGrow ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 486) (= __@x0 Wasm.Ast.MemoryGrow)))
(define-fun is-Wasm.Ast.Const ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 488) (= __@x0 (Wasm.Ast.Const (Wasm.Ast.Const__0 __@x0)))))
(define-fun is-Wasm.Ast.Test ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 493) (= __@x0 (Wasm.Ast.Test (Wasm.Ast.Test__0 __@x0)))))
(define-fun is-Wasm.Ast.Compare ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 498) (= __@x0 (Wasm.Ast.Compare (Wasm.Ast.Compare__0 __@x0)))))
(define-fun is-Wasm.Ast.Unary ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 503) (= __@x0 (Wasm.Ast.Unary (Wasm.Ast.Unary__0 __@x0)))))
(define-fun is-Wasm.Ast.Binary ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 508) (= __@x0 (Wasm.Ast.Binary (Wasm.Ast.Binary__0 __@x0)))))
(define-fun is-Wasm.Ast.Convert ((__@x0 Term)) Bool (and (= (Term_constr_id __@x0) 513) (= __@x0 (Wasm.Ast.Convert (Wasm.Ast.Convert__0 __@x0)))))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term)) (! (= (HasTypeFuel @u0 @x1 Tm_refine_0ef7e58b828ca754b2e6a14569e95e48) (and (HasTypeFuel @u0 @x1 Wasm.Ast.instr_) (BoxBool_proj_0 (Wasm.Ast.uu___is_Compare @x1)) )) :pattern ((HasTypeFuel @u0 @x1 Tm_refine_0ef7e58b828ca754b2e6a14569e95e48)) :qid refinement_interpretation_Tm_refine_0ef7e58b828ca754b2e6a14569e95e48)) :named refinement_interpretation_Tm_refine_0ef7e58b828ca754b2e6a14569e95e48))
...
(assert (! (not (forall ((@x0 Term)) (! (=> (and (HasType @x0 Tm_refine_0ef7e58b828ca754b2e6a14569e95e48) (not (BoxBool_proj_0 (Wasm.Ast.uu___is_Compare @x0)) ) ) label_43) :qid @query))) :named query))
(check-sat)
