...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_4b8c2598b0aead43d115e659bbb5bd9d @x2 @x3)) (and (HasTypeFuel @u0 @x1 (Semantics.Common.CFG.Instructions.ins_t @x2 @x3)) (BoxBool_proj_0 (Semantics.Common.CFG.Instructions.uu___is_FMov32 @x2 @x3 @x1)) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_4b8c2598b0aead43d115e659bbb5bd9d @x2 @x3))) :qid refinement_interpretation_Tm_refine_4b8c2598b0aead43d115e659bbb5bd9d)) :named refinement_interpretation_Tm_refine_4b8c2598b0aead43d115e659bbb5bd9d))
...
(push)
(declare-fun label_248 () Bool)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x1 Tm_arrow_2b00b574e3c859da902fc1b8ce85c0f1) (HasType @x2 (Tm_refine_4b8c2598b0aead43d115e659bbb5bd9d @x0 @x1)) (not (BoxBool_proj_0 (Semantics.Common.CFG.Instructions.uu___is_FMov32 @x0 @x1 @x2)) ) ) label_248) :qid @query))) :named query))
(check-sat)
