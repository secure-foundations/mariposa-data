...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term)) (! (= (FStar.Pervasives.Native.Mktuple3__1 (FStar.Pervasives.Native.Mktuple3 @x0 @x1 @x2 @x3 @x4 @x5)) @x3) :pattern ((FStar.Pervasives.Native.Mktuple3 @x0 @x1 @x2 @x3 @x4 @x5)) :qid projection_inverse_FStar.Pervasives.Native.Mktuple3__1)) :named projection_inverse_FStar.Pervasives.Native.Mktuple3__1))
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term)) (! (= (FStar.Pervasives.Native.Mktuple3__3 (FStar.Pervasives.Native.Mktuple3 @x0 @x1 @x2 @x3 @x4 @x5)) @x5) :pattern ((FStar.Pervasives.Native.Mktuple3 @x0 @x1 @x2 @x3 @x4 @x5)) :qid projection_inverse_FStar.Pervasives.Native.Mktuple3__3)) :named projection_inverse_FStar.Pervasives.Native.Mktuple3__3))
...
(push)
(declare-fun label_145 () Bool)
(declare-fun label_144 () Bool)
(declare-fun label_143 () Bool)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (Prims.list @x0)) (HasType @x2 (Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0 @x1)) (HasType @x3 @x0)) (and (forall ((@x4 Term)) (! (=> (HasType @x4 (Prims.list @x0)) (or label_143 (Valid (Prims.hasEq Prims.nat) ) ) ) :qid @query.1)) (forall ((@x4 Term)) (! (=> (HasType @x4 (Prims.list @x0)) (or label_144 (Valid (Prims.hasEq Prims.nat) ) ) ) :qid @query.2)) (forall ((@x4 Term)) (! (=> (HasType @x4 (Prims.list @x0)) (forall ((@x5 Term)) (! (=> (HasType @x5 @x0) (forall ((@x6 Term)) (! (=> (and (HasType @x6 (Prims.list @x0)) (= (FStar.List.Tot.Base.split3 @x0 @x1 @x2) (FStar.Pervasives.Native.Mktuple3 (Prims.list @x0) @x0 (Prims.list @x0) @x4 @x5 @x6)) ) (forall ((@x7 Term)) (! (=> (and (HasType @x7 Prims.unit) (let ((@lb8 (FStar.List.Tot.Base.split3 @x0 @x1 @x2))) (and (= (FStar.List.Tot.Base.length @x0 (FStar.Pervasives.Native.Mktuple3__1 @lb8)) @x2) (= (FStar.List.Tot.Base.length @x0 (FStar.Pervasives.Native.Mktuple3__3 @lb8)) (Prims.op_Subtraction (Prims.op_Subtraction (FStar.List.Tot.Base.length @x0 @x1) @x2) (BoxInt 1))) ) )) (forall ((@x8 Term)) (! (=> (and (HasType @x8 Prims.unit) (= (FStar.List.Tot.Base.length @x0 (FStar.List.Tot.Base.op_At @x0 @x4 (Prims.Cons @x0 @x3 @x6))) (Prims.op_Addition (FStar.List.Tot.Base.length @x0 @x4) (FStar.List.Tot.Base.length @x0 (Prims.Cons @x0 @x3 @x6)))) ) (or label_145 (= (FStar.List.Tot.Base.length @x0 @x1) (FStar.List.Tot.Base.length @x0 (FStar.List.Tot.Base.append @x0 @x4 (Prims.Cons @x0 @x3 @x6)))) ) ) :qid @query.7)) ) :qid @query.6)) ) :qid @query.5)) ) :qid @query.4)) ) :qid @query.3)) ) ) :qid @query))) :named query))
(check-sat)
