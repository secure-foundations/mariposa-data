...
(assert (! (not (forall ((@x0 Term)) (! (=> (and (HasType @x0 Prims.nat) (> (BoxInt_proj_0 (let ((@lb1 @x0)) (ite (= @lb1 (BoxInt 0)) (BoxInt 1) (Prims.op_Multiply (BoxInt 2) (Prims.pow2 (Prims.op_Subtraction @x0 (BoxInt 1))))))) (BoxInt_proj_0 (BoxInt 0))) ) (or label_35 (>= (BoxInt_proj_0 (let ((@lb1 @x0)) (ite (= @lb1 (BoxInt 0)) (BoxInt 1) (Prims.op_Multiply (BoxInt 2) (Prims.pow2 (Prims.op_Subtraction @x0 (BoxInt 1))))))) (BoxInt_proj_0 (BoxInt 0))) ) ) :qid @query))) :named query))
(check-sat)
