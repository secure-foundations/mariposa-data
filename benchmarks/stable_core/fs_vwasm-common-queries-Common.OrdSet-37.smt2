...
(assert (! (forall ((@x0 Term)) (! (= 108 (Term_constr_id (FStar.Pervasives.Native.None @x0))) :pattern ((FStar.Pervasives.Native.None @x0)) :qid constructor_distinct_FStar.Pervasives.Native.None)) :named constructor_distinct_FStar.Pervasives.Native.None))
(assert (! (forall ((@x0 Term)) (! (= (FStar.Pervasives.Native.None_a (FStar.Pervasives.Native.None @x0)) @x0) :pattern ((FStar.Pervasives.Native.None @x0)) :qid projection_inverse_FStar.Pervasives.Native.None_a)) :named projection_inverse_FStar.Pervasives.Native.None_a))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (FStar.Pervasives.Native.uu___is_None @x0 @x1) (BoxBool (is-FStar.Pervasives.Native.None @x1))) :pattern ((FStar.Pervasives.Native.uu___is_None @x0 @x1)) :qid disc_equation_FStar.Pervasives.Native.None)) :named disc_equation_FStar.Pervasives.Native.None))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (Common.OrdSet.choose @x0 @x1 @x2) (let ((@lb3 @x2)) (ite (is-Prims.Nil @lb3) (FStar.Pervasives.Native.None @x0) (ite (is-Prims.Cons @lb3) (FStar.Pervasives.Native.Some @x0 (Prims.Cons_hd @lb3)) Tm_unit)))) :pattern ((Common.OrdSet.choose @x0 @x1 @x2)) :qid equation_Common.OrdSet.choose)) :named equation_Common.OrdSet.choose))
...
(push)
(declare-fun label_185 () Bool)
(declare-fun label_184 () Bool)
(push)
(assert (! (= MaxFuel (SFuel (SFuel ZFuel))) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0))) (forall ((@x2 Term)) (! (=> (and (HasType @x2 (Prims.pure_post Prims.unit)) (forall ((@x3 Term)) (! (=> (and (or label_184 (HasType @x3 Prims.unit)) (or label_185 (BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0 (Common.OrdSet.choose @x0 @x1 (Common.OrdSet.empty @x0 @x1)))) ) ) (Valid (ApplyTT @x2 @x3) ) ) :pattern ( (Valid (ApplyTT @x2 @x3) ) ) :qid @query.2)) ) (forall ((@x3 Term)) (! (=> (HasType @x3 Prims.unit) (Valid (ApplyTT @x2 @x3) ) ) :qid @query.3)) ) :qid @query.1)) ) :qid @query))) :named query))
(check-sat)
