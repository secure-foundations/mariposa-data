...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 Prims.nat) (HasType (Prims.pow2 @x0) Prims.pos)) :pattern ((Prims.pow2 @x0)) :qid typing_Prims.pow2)) :named typing_Prims.pow2))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (FStar.UInt.sub_mod @x0 @x1 @x2) (Prims.op_Modulus (Prims.op_Subtraction @x1 @x2) (Prims.pow2 @x0))) :pattern ((FStar.UInt.sub_mod @x0 @x1 @x2)) :qid equation_FStar.UInt.sub_mod)) :named equation_FStar.UInt.sub_mod))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (FStar.UInt.mod @x0 @x1 @x2) (Prims.op_Subtraction @x1 (Prims.op_Multiply (Prims.op_Division @x1 @x2) @x2))) :pattern ((FStar.UInt.mod @x0 @x1 @x2)) :qid equation_FStar.UInt.mod)) :named equation_FStar.UInt.mod))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (=> (and (HasType @x0 Prims.nat) (HasType @x1 Prims.int)) (HasType (FStar.UInt.to_uint_t @x0 @x1) (FStar.UInt.uint_t @x0))) :pattern ((FStar.UInt.to_uint_t @x0 @x1)) :qid typing_FStar.UInt.to_uint_t)) :named typing_FStar.UInt.to_uint_t))
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (FStar.UInt.to_uint_t @x0 @x1) (Prims.op_Modulus @x1 (Prims.pow2 @x0))) :pattern ((FStar.UInt.to_uint_t @x0 @x1)) :qid equation_FStar.UInt.to_uint_t)) :named equation_FStar.UInt.to_uint_t))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term)) (! (= (HasTypeFuel @u0 @x1 Tm_refine_0941c9ff95557f2d53bc8f8179ab793e) (and (HasTypeFuel @u0 @x1 (FStar.UInt32.t Dummy_value)) (not (= (FStar.UInt32.v @x1) (BoxInt 0))) )) :pattern ((HasTypeFuel @u0 @x1 Tm_refine_0941c9ff95557f2d53bc8f8179ab793e)) :qid refinement_interpretation_Tm_refine_0941c9ff95557f2d53bc8f8179ab793e)) :named refinement_interpretation_Tm_refine_0941c9ff95557f2d53bc8f8179ab793e))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_19ac6a052799e5086e9c3eb3a21d54a5 @x2 @x3)) (and (HasTypeFuel @u0 @x1 (FStar.UInt32.t Dummy_value)) (= (FStar.UInt.mod (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1)) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_19ac6a052799e5086e9c3eb3a21d54a5 @x2 @x3))) :qid refinement_interpretation_Tm_refine_19ac6a052799e5086e9c3eb3a21d54a5)) :named refinement_interpretation_Tm_refine_19ac6a052799e5086e9c3eb3a21d54a5))
(declare-fun Tm_arrow_a00bbce6d7d4a1d495177d4f11116643 () Term)
(declare-fun FStar.UInt32.rem@tok () Term)
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (=> (and (HasType @x0 (FStar.UInt32.t Dummy_value)) (HasType @x1 Tm_refine_0941c9ff95557f2d53bc8f8179ab793e)) (HasType (FStar.UInt32.rem @x0 @x1) (Tm_refine_19ac6a052799e5086e9c3eb3a21d54a5 @x0 @x1))) :pattern ((FStar.UInt32.rem @x0 @x1)) :qid typing_FStar.UInt32.rem)) :named typing_FStar.UInt32.rem))
...
(assert (! (forall ((@u0 Dummy_sort)) (! (= (Wasm.I32.t @u0) (FStar.UInt32.t Dummy_value)) :pattern ( (Wasm.I32.t @u0) ) :qid equation_Wasm.I32.t)) :named equation_Wasm.I32.t))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 Prims.int) (HasType (Wasm.I32.of_int_s @x0) (Wasm.I32.t Dummy_value))) :pattern ((Wasm.I32.of_int_s @x0)) :qid typing_Wasm.I32.of_int_s)) :named typing_Wasm.I32.of_int_s))
(assert (! (forall ((@x0 Term)) (! (= (Wasm.I32.of_int_s @x0) (FStar.UInt32.uint_to_t (FStar.UInt.to_uint_t (BoxInt 32) @x0))) :pattern ((Wasm.I32.of_int_s @x0)) :qid equation_Wasm.I32.of_int_s)) :named equation_Wasm.I32.of_int_s))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt32.t Dummy_value)) (HasType (Wasm.I32.clamp_mask @x0) (FStar.UInt32.t Dummy_value))) :pattern ((Wasm.I32.clamp_mask @x0)) :qid typing_Wasm.I32.clamp_mask)) :named typing_Wasm.I32.clamp_mask))
(assert (! (forall ((@x0 Term)) (! (= (Wasm.I32.clamp_mask @x0) (FStar.UInt32.uint_to_t (FStar.UInt32.v (FStar.UInt32.rem @x0 (Wasm.I32.of_int_s (BoxInt 32)))))) :pattern ((Wasm.I32.clamp_mask @x0)) :qid equation_Wasm.I32.clamp_mask)) :named equation_Wasm.I32.clamp_mask))
...
(assert (! (not (forall ((@x0 Term) (@x1 Term)) (! (=> (and (HasType @x0 (Wasm.I32.t Dummy_value)) (HasType @x1 (Wasm.I32.t Dummy_value))) (and (or label_27 (Valid (FStar.UInt.size (BoxInt 32) (BoxInt 32)) ) ) (forall ((@x2 Term)) (! (=> (and (HasType @x2 Prims.int) (= (BoxInt 32) @x2) ) (forall ((@x3 Term)) (! (=> (and (HasType @x3 (FStar.UInt32.t Dummy_value)) (= (FStar.UInt32.v @x3) (BoxInt 32)) (= (FStar.UInt32.uint_to_t (BoxInt 32)) @x3) ) (forall ((@x4 Term)) (! (=> (and (HasType @x4 (FStar.UInt32.t Dummy_value)) (= (FStar.UInt.sub_mod (BoxInt 32) (BoxInt 32) (FStar.UInt32.v (Wasm.I32.clamp_mask @x1))) (FStar.UInt32.v @x4)) (= (FStar.UInt32.sub_mod (FStar.UInt32.uint_to_t (BoxInt 32)) (Wasm.I32.clamp_mask @x1)) @x4) (not (= (Prims.op_Equality Prims.int (FStar.UInt32.v (Wasm.I32.clamp_mask @x1)) (BoxInt 0)) (BoxBool true)) ) ) (forall ((@x5 Term)) (! (=> (and (HasType @x5 Prims.bool) (= (Prims.op_Equality Prims.int (FStar.UInt32.v (Wasm.I32.clamp_mask @x1)) (BoxInt 0)) @x5) ) (and (or label_28 (< (BoxInt_proj_0 (FStar.UInt32.v (Wasm.I32.clamp_mask @x1))) (BoxInt_proj_0 (BoxInt 32))) ) (forall ((@x6 Term)) (! (=> (and (HasType @x6 (FStar.UInt32.t Dummy_value)) (= (FStar.UInt.shift_left (BoxInt 32) (FStar.UInt32.v @x0) (FStar.UInt32.v (Wasm.I32.clamp_mask @x1))) (FStar.UInt32.v @x6)) (= (FStar.UInt32.shift_left @x0 (Wasm.I32.clamp_mask @x1)) @x6) ) (or label_29 (< (BoxInt_proj_0 (FStar.UInt32.v (FStar.UInt32.sub_mod (FStar.UInt32.uint_to_t (BoxInt 32)) (Wasm.I32.clamp_mask @x1)))) (BoxInt_proj_0 (BoxInt 32))) ) ) :qid @query.5)) ) ) :qid @query.4)) ) :qid @query.3)) ) :qid @query.2)) ) :qid @query.1)) ) ) :qid @query))) :named query))
(check-sat)
