...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term)) (! (= (Compiler.Common.Dataflow.Mklattice_join (Compiler.Common.Dataflow.Mklattice @x0 @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12)) @x3) :pattern ((Compiler.Common.Dataflow.Mklattice @x0 @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12)) :qid projection_inverse_Compiler.Common.Dataflow.Mklattice_join)) :named projection_inverse_Compiler.Common.Dataflow.Mklattice_join))
...
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__join@tok @x0) (Compiler.Common.Dataflow.__proj__Mklattice__item__join @x0)) :pattern ((ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__join@tok @x0)) :qid token_correspondence_Compiler.Common.Dataflow.__proj__Mklattice__item__join)) :named token_correspondence_Compiler.Common.Dataflow.__proj__Mklattice__item__join))
(assert (! (forall ((@x0 Term)) (! (= (Compiler.Common.Dataflow.__proj__Mklattice__item__join @x0) (Compiler.Common.Dataflow.Mklattice_join @x0)) :pattern ((Compiler.Common.Dataflow.__proj__Mklattice__item__join @x0)) :qid proj_equation_Compiler.Common.Dataflow.Mklattice_join)) :named proj_equation_Compiler.Common.Dataflow.Mklattice_join))
...
(assert (! (not (forall ((@x0 Term)) (! (=> (HasType @x0 Compiler.Common.Dataflow.lattice) (forall ((@x1 Term)) (! (=> (HasType @x1 Prims.eqtype) (forall ((@x2 Term)) (! (=> (HasType @x2 @x1) (forall ((@x3 Term)) (! (=> (HasType @x3 @x1) (forall ((@x4 Term)) (! (=> (HasType @x4 (Compiler.Common.Dataflow.lat_op_t @x1)) (forall ((@x5 Term)) (! (=> (HasType @x5 (Compiler.Common.Dataflow.lat_op_t @x1)) (forall ((@x6 Term)) (! (=> (HasType @x6 (Compiler.Common.Dataflow.lat_comm_t @x1 @x4)) (forall ((@x7 Term)) (! (=> (HasType @x7 (Compiler.Common.Dataflow.lat_comm_t @x1 @x5)) (forall ((@x8 Term)) (! (=> (HasType @x8 (Compiler.Common.Dataflow.lat_assoc_t @x1 @x4)) (forall ((@x9 Term)) (! (=> (HasType @x9 (Compiler.Common.Dataflow.lat_assoc_t @x1 @x5)) (forall ((@x10 Term)) (! (=> (HasType @x10 (Compiler.Common.Dataflow.lat_absorb_t @x1 @x4 @x5)) (forall ((@x11 Term)) (! (=> (HasType @x11 (Compiler.Common.Dataflow.lat_absorb_t @x1 @x5 @x4)) (forall ((@x12 Term)) (! (=> (HasType @x12 (Compiler.Common.Dataflow.lat_ident_t @x1 @x4 @x2)) (forall ((@x13 Term)) (! (=> (and (HasType @x13 (Compiler.Common.Dataflow.lat_ident_t @x1 @x5 @x3)) (= @x0 (Compiler.Common.Dataflow.Mklattice @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12 @x13)) ) (and (forall ((@x14 Term)) (! (=> (HasType @x14 (Compiler.Common.Dataflow.__proj__Mklattice__item__t @x0)) (or label_23 (HasType @x14 @x1)) ) :qid @query.14)) (forall ((@x14 Term)) (! (=> (HasType @x14 @x1) (and (forall ((@x15 Term)) (! (=> (HasType @x15 (Compiler.Common.Dataflow.__proj__Mklattice__item__t @x0)) (or label_24 (HasType @x15 @x1)) ) :qid @query.16)) (forall ((@x15 Term) (@x16 Term)) (! (=> (and (HasType @x15 @x1) (HasType @x16 (Prims.pure_post Prims.unit)) (forall ((@x17 Term)) (! (=> (and (HasType @x17 Prims.unit) (= (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__join@tok @x0) @x14) (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__meet@tok @x0) @x14) @x15)) @x14) ) (Valid (ApplyTT @x16 @x17) ) ) :qid @query.18)) ) (forall ((@x17 Term)) (! (=> (and (HasType @x17 Prims.unit) (= (ApplyTT (ApplyTT @x4 @x14) (ApplyTT (ApplyTT @x5 @x14) @x15)) @x14) ) (or label_25 (Valid (ApplyTT @x16 @x17) ) ) ) :qid @query.19)) ) :qid @query.17)) ) ) :qid @query.15)) ) ) :qid @query.13)) ) :qid @query.12)) ) :qid @query.11)) ) :qid @query.10)) ) :qid @query.9)) ) :qid @query.8)) ) :qid @query.7)) ) :qid @query.6)) ) :qid @query.5)) ) :qid @query.4)) ) :qid @query.3)) ) :qid @query.2)) ) :qid @query.1)) ) :qid @query))) :named query))
(check-sat)
