...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (HasTypeZ @x0 (Tm_ghost_arrow_0283b8a2a36bbec52abac4e3d837674a @x1 @x2)) (forall ((@x3 Term)) (! (=> (HasType @x3 @x2) (HasType (ApplyTT @x0 @x3) @x1)) :pattern ((ApplyTT @x0 @x3)) :qid Prims_interpretation_Tm_ghost_arrow_0283b8a2a36bbec52abac4e3d837674a.1)) ) :pattern ((HasTypeZ @x0 (Tm_ghost_arrow_0283b8a2a36bbec52abac4e3d837674a @x1 @x2))) :qid Prims_interpretation_Tm_ghost_arrow_0283b8a2a36bbec52abac4e3d837674a)) :named Prims_interpretation_Tm_ghost_arrow_0283b8a2a36bbec52abac4e3d837674a))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Prims.op_Multiply @x0 @x1) (BoxInt (* (BoxInt_proj_0 @x0) (BoxInt_proj_0 @x1)))) :pattern ((Prims.op_Multiply @x0 @x1)) :qid primitive_Prims.op_Multiply)) :named primitive_Prims.op_Multiply))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Prims.op_Modulus @x0 @x1) (BoxInt (mod (BoxInt_proj_0 @x0) (BoxInt_proj_0 @x1)))) :pattern ((Prims.op_Modulus @x0 @x1)) :qid primitive_Prims.op_Modulus)) :named primitive_Prims.op_Modulus))
(declare-fun Prims.op_Division (Term Term) Term)
(declare-fun Prims.op_Division@tok () Term)
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Prims.op_Division @x0 @x1) (BoxInt (div (BoxInt_proj_0 @x0) (BoxInt_proj_0 @x1)))) :pattern ((Prims.op_Division @x0 @x1)) :qid primitive_Prims.op_Division)) :named primitive_Prims.op_Division))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term)) (! (=> (HasType @x1 Prims.nat) (= (Prims.pow2.fuel_instrumented (SFuel @u0) @x1) (let ((@lb2 @x1)) (ite (= @lb2 (BoxInt 0)) (BoxInt 1) (Prims.op_Multiply (BoxInt 2) (Prims.pow2.fuel_instrumented @u0 (Prims.op_Subtraction @x1 (BoxInt 1)))))))) :weight 0 :pattern ((Prims.pow2.fuel_instrumented (SFuel @u0) @x1)) :qid equation_with_fuel_Prims.pow2.fuel_instrumented)) :named equation_with_fuel_Prims.pow2.fuel_instrumented))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0))) (HasType (FStar.Seq.Base.length @x0 @x1) Prims.nat)) :pattern ((FStar.Seq.Base.length @x0 @x1)) :qid typing_FStar.Seq.Base.length)) :named typing_FStar.Seq.Base.length))
(declare-fun Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 (Term Term) Term)
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x2 @x3)) (and (HasTypeFuel @u0 @x1 Prims.nat) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 (FStar.Seq.Base.length @x2 @x3))) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x2 @x3))) :qid refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55)) :named refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0 @x1))) (HasType (FStar.Seq.Base.index @x0 @x1 @x2) @x0)) :pattern ((FStar.Seq.Base.index @x0 @x1 @x2)) :qid typing_FStar.Seq.Base.index)) :named typing_FStar.Seq.Base.index))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 Prims.nat) (HasType @x2 @x0)) (HasType (FStar.Seq.Base.create @x0 @x1 @x2) (FStar.Seq.Base.seq @x0))) :pattern ((FStar.Seq.Base.create @x0 @x1 @x2)) :qid typing_FStar.Seq.Base.create)) :named typing_FStar.Seq.Base.create))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0 @x1)) (HasType @x3 @x0)) (HasType (FStar.Seq.Base.upd @x0 @x1 @x2 @x3) (FStar.Seq.Base.seq @x0))) :pattern ((FStar.Seq.Base.upd @x0 @x1 @x2 @x3)) :qid typing_FStar.Seq.Base.upd)) :named typing_FStar.Seq.Base.upd))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 Prims.nat) (HasType @x2 @x0)) (= (FStar.Seq.Base.length @x0 (FStar.Seq.Base.create @x0 @x1 @x2)) @x1) ) :pattern ((FStar.Seq.Base.length @x0 (FStar.Seq.Base.create @x0 @x1 @x2))) :qid lemma_FStar.Seq.Base.lemma_create_len)) :named lemma_FStar.Seq.Base.lemma_create_len))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_2ca062977a42c36634b89c1c4f193f79 @x2 @x3)) (and (HasTypeFuel @u0 @x1 (FStar.Seq.Base.seq @x3)) (< (BoxInt_proj_0 @x2) (BoxInt_proj_0 (FStar.Seq.Base.length @x3 @x1))) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_2ca062977a42c36634b89c1c4f193f79 @x2 @x3))) :qid refinement_interpretation_Tm_refine_2ca062977a42c36634b89c1c4f193f79)) :named refinement_interpretation_Tm_refine_2ca062977a42c36634b89c1c4f193f79))
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 Prims.nat) (HasType @x2 @x0) (HasType @x3 (Tm_refine_2ca062977a42c36634b89c1c4f193f79 @x1 @x0))) (= (FStar.Seq.Base.length @x0 (FStar.Seq.Base.upd @x0 @x3 @x1 @x2)) (FStar.Seq.Base.length @x0 @x3)) ) :pattern ((FStar.Seq.Base.length @x0 (FStar.Seq.Base.upd @x0 @x3 @x1 @x2))) :qid lemma_FStar.Seq.Base.lemma_len_upd)) :named lemma_FStar.Seq.Base.lemma_len_upd))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0 @x1)) (HasType @x3 @x0)) (= (FStar.Seq.Base.index @x0 (FStar.Seq.Base.upd @x0 @x1 @x2 @x3) @x2) @x3) ) :pattern ((FStar.Seq.Base.index @x0 (FStar.Seq.Base.upd @x0 @x1 @x2 @x3) @x2)) :qid lemma_FStar.Seq.Base.lemma_index_upd1)) :named lemma_FStar.Seq.Base.lemma_index_upd1))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_df81b3f17797c6f405c1dbb191651292 @x2 @x3 @x4)) (and (HasTypeFuel @u0 @x1 Prims.nat) (not (= @x1 @x2)) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 (FStar.Seq.Base.length @x3 @x4))) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_df81b3f17797c6f405c1dbb191651292 @x2 @x3 @x4))) :qid refinement_interpretation_Tm_refine_df81b3f17797c6f405c1dbb191651292)) :named refinement_interpretation_Tm_refine_df81b3f17797c6f405c1dbb191651292))
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0 @x1)) (HasType @x3 @x0) (HasType @x4 (Tm_refine_df81b3f17797c6f405c1dbb191651292 @x2 @x0 @x1))) (= (FStar.Seq.Base.index @x0 (FStar.Seq.Base.upd @x0 @x1 @x2 @x3) @x4) (FStar.Seq.Base.index @x0 @x1 @x4)) ) :pattern ((FStar.Seq.Base.index @x0 (FStar.Seq.Base.upd @x0 @x1 @x2 @x3) @x4)) :qid lemma_FStar.Seq.Base.lemma_index_upd2)) :named lemma_FStar.Seq.Base.lemma_index_upd2))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (FStar.Seq.Base.seq @x0)) (= (FStar.Seq.Base.length @x0 @x1) (FStar.Seq.Base.length @x0 @x2)) (forall ((@x3 Term)) (! (=> (HasType @x3 (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0 @x1)) (= (FStar.Seq.Base.index @x0 @x1 @x3) (FStar.Seq.Base.index @x0 @x2 @x3)) ) :pattern ((FStar.Seq.Base.index @x0 @x1 @x3) (FStar.Seq.Base.index @x0 @x2 @x3)) :qid lemma_FStar.Seq.Base.lemma_eq_intro.1)) ) (Valid (FStar.Seq.Base.equal @x0 @x1 @x2) ) ) :pattern ((FStar.Seq.Base.equal @x0 @x1 @x2)) :qid lemma_FStar.Seq.Base.lemma_eq_intro)) :named lemma_FStar.Seq.Base.lemma_eq_intro))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Tm_type) (HasType @x1 (FStar.Seq.Base.seq @x0)) (HasType @x2 (FStar.Seq.Base.seq @x0)) (Valid (FStar.Seq.Base.equal @x0 @x1 @x2) ) ) (= @x1 @x2) ) :pattern ((FStar.Seq.Base.equal @x0 @x1 @x2)) :qid lemma_FStar.Seq.Base.lemma_eq_elim)) :named lemma_FStar.Seq.Base.lemma_eq_elim))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x2 @x3)) (and (HasTypeFuel @u0 @x1 (FStar.Seq.Base.seq @x2)) (= (FStar.Seq.Base.length @x2 @x1) @x3) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x2 @x3))) :qid refinement_interpretation_Tm_refine_a0cd7d06c5da6444b6b51b319febde8e)) :named refinement_interpretation_Tm_refine_a0cd7d06c5da6444b6b51b319febde8e))
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (FStar.Seq.Properties.lseq @x0 @x1) (Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x0 @x1)) :pattern ((FStar.Seq.Properties.lseq @x0 @x1)) :qid equation_FStar.Seq.Properties.lseq)) :named equation_FStar.Seq.Properties.lseq))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 Prims.nat) (let ((@lb1 @x0)) (ite (= @lb1 (BoxInt 0)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 1)) (ite (= @lb1 (BoxInt 1)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 2)) (ite (= @lb1 (BoxInt 8)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 256)) (ite (= @lb1 (BoxInt 16)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 65536)) (ite (= @lb1 (BoxInt 31)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 2147483648)) (ite (= @lb1 (BoxInt 32)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 4294967296)) (ite (= @lb1 (BoxInt 63)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 9223372036854775808)) (ite (= @lb1 (BoxInt 64)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 18446744073709551616)) (=> (= @lb1 (BoxInt 128)) (= (Prims.pow2.fuel_instrumented ZFuel @x0) (BoxInt 340282366920938463463374607431768211456)) ))))))))))) :pattern ((Prims.pow2.fuel_instrumented ZFuel @x0)) :qid lemma_FStar.UInt.pow2_values)) :named lemma_FStar.UInt.pow2_values))
...
(assert (! (forall ((@x0 Term)) (! (= (FStar.UInt.max_int @x0) (Prims.op_Subtraction (Prims.pow2 @x0) (BoxInt 1))) :pattern ((FStar.UInt.max_int @x0)) :qid equation_FStar.UInt.max_int)) :named equation_FStar.UInt.max_int))
(declare-fun FStar.UInt.min_int (Term) Term)
(declare-fun FStar.UInt.min_int@tok () Term)
(assert (! (forall ((@x0 Term)) (! (= (FStar.UInt.min_int @x0) (BoxInt 0)) :pattern ((FStar.UInt.min_int @x0)) :qid equation_FStar.UInt.min_int)) :named equation_FStar.UInt.min_int))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (FStar.UInt.fits @x0 @x1) (Prims.op_AmpAmp (Prims.op_LessThanOrEqual (FStar.UInt.min_int @x1) @x0) (Prims.op_LessThanOrEqual @x0 (FStar.UInt.max_int @x1)))) :pattern ((FStar.UInt.fits @x0 @x1)) :qid equation_FStar.UInt.fits)) :named equation_FStar.UInt.fits))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (FStar.UInt.size @x0 @x1) (Prims.b2t (FStar.UInt.fits @x0 @x1))) :pattern ((FStar.UInt.size @x0 @x1)) :qid equation_FStar.UInt.size)) :named equation_FStar.UInt.size))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_f13070840248fced9d9d60d77bdae3ec @x2)) (and (HasTypeFuel @u0 @x1 Prims.int) (Valid (FStar.UInt.size @x1 @x2) ) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_f13070840248fced9d9d60d77bdae3ec @x2))) :qid refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec)) :named refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec))
(assert (! (forall ((@x0 Term)) (! (= (FStar.UInt.uint_t @x0) (Tm_refine_f13070840248fced9d9d60d77bdae3ec @x0)) :pattern ((FStar.UInt.uint_t @x0)) :qid equation_FStar.UInt.uint_t)) :named equation_FStar.UInt.uint_t))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt32.t Dummy_value)) (HasType (FStar.UInt32.v @x0) (FStar.UInt.uint_t (BoxInt 32)))) :pattern ((FStar.UInt32.v @x0)) :qid typing_FStar.UInt32.v)) :named typing_FStar.UInt32.v))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt32.t Dummy_value)) (= (FStar.UInt32.uint_to_t (FStar.UInt32.v @x0)) @x0) ) :pattern ((FStar.UInt32.v @x0)) :qid lemma_FStar.UInt32.uv_inv)) :named lemma_FStar.UInt32.uv_inv))
(declare-fun FStar.UInt32.vu_inv (Term) Term)
(declare-fun FStar.UInt32.vu_inv@tok () Term)
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt.uint_t (BoxInt 32))) (= (FStar.UInt32.v (FStar.UInt32.uint_to_t @x0)) @x0) ) :pattern ((FStar.UInt32.uint_to_t @x0)) :qid lemma_FStar.UInt32.vu_inv)) :named lemma_FStar.UInt32.vu_inv))
...
(assert (! (forall ((@x0 Term) (@u1 Fuel) (@u2 Dummy_sort)) (! (=> (HasTypeFuel @u1 @x0 (FStar.UInt8.t @u2)) (= (FStar.UInt8.t @u2) (PreType @x0))) :pattern ((HasTypeFuel @u1 @x0 (FStar.UInt8.t @u2))) :qid FStar.UInt8_pretyping_512f0e4172b97206a8b0e16196475713)) :named FStar.UInt8_pretyping_512f0e4172b97206a8b0e16196475713))
(assert (! (forall ((@u0 Dummy_sort)) (! (HasType (FStar.UInt8.t @u0) Prims.eqtype) :pattern ((FStar.UInt8.t @u0)) :qid typing_FStar.UInt8.t)) :named typing_FStar.UInt8.t))
...
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt8.t Dummy_value)) (HasType (FStar.UInt8.v @x0) (FStar.UInt.uint_t (BoxInt 8)))) :pattern ((FStar.UInt8.v @x0)) :qid typing_FStar.UInt8.v)) :named typing_FStar.UInt8.v))
(declare-fun FStar.UInt8.uint_to_t (Term) Term)
(declare-fun Tm_refine_25c72d704900d626b30894312c325451 (Term) Term)
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term)) (! (= (HasTypeFuel @u0 @x1 (Tm_refine_25c72d704900d626b30894312c325451 @x2)) (and (HasTypeFuel @u0 @x1 (FStar.UInt8.t Dummy_value)) (= (FStar.UInt8.v @x1) @x2) )) :pattern ((HasTypeFuel @u0 @x1 (Tm_refine_25c72d704900d626b30894312c325451 @x2))) :qid refinement_interpretation_Tm_refine_25c72d704900d626b30894312c325451)) :named refinement_interpretation_Tm_refine_25c72d704900d626b30894312c325451))
(declare-fun Tm_arrow_99681d89836a4c650badaf3b898e0fd2 () Term)
(declare-fun FStar.UInt8.uint_to_t@tok () Term)
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt.uint_t (BoxInt 8))) (HasType (FStar.UInt8.uint_to_t @x0) (Tm_refine_25c72d704900d626b30894312c325451 @x0))) :pattern ((FStar.UInt8.uint_to_t @x0)) :qid typing_FStar.UInt8.uint_to_t)) :named typing_FStar.UInt8.uint_to_t))
(declare-fun FStar.UInt8.uv_inv (Term) Term)
(declare-fun FStar.UInt8.uv_inv@tok () Term)
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt8.t Dummy_value)) (= (FStar.UInt8.uint_to_t (FStar.UInt8.v @x0)) @x0) ) :pattern ((FStar.UInt8.v @x0)) :qid lemma_FStar.UInt8.uv_inv)) :named lemma_FStar.UInt8.uv_inv))
(declare-fun FStar.UInt8.vu_inv (Term) Term)
(declare-fun FStar.UInt8.vu_inv@tok () Term)
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt.uint_t (BoxInt 8))) (= (FStar.UInt8.v (FStar.UInt8.uint_to_t @x0)) @x0) ) :pattern ((FStar.UInt8.uint_to_t @x0)) :qid lemma_FStar.UInt8.vu_inv)) :named lemma_FStar.UInt8.vu_inv))
...
(assert (! (forall ((@x0 Term)) (! (and (NoHoist @x0 (HasType Opaque_s.make_opaque@tok Tm_arrow_99724436653747ac6f5a6a00c64ff8bc)) (forall ((@x1 Term) (@x2 Term)) (! (= (ApplyTT (ApplyTT Opaque_s.make_opaque@tok @x1) @x2) (Opaque_s.make_opaque @x1 @x2)) :pattern ((Opaque_s.make_opaque @x1 @x2)) :qid function_token_typing_Opaque_s.make_opaque.1)) ) :pattern ((ApplyTT @x0 Opaque_s.make_opaque@tok)) :qid function_token_typing_Opaque_s.make_opaque)) :named function_token_typing_Opaque_s.make_opaque))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (Valid (LowStar.BufferView.inverses @x0 @x1 @x2 @x3)) (and (forall ((@x4 Term)) (! (=> (HasType @x4 @x0) (= (ApplyTT @x3 (ApplyTT @x2 @x4)) @x4) ) :qid equation_LowStar.BufferView.inverses.1)) (forall ((@x4 Term)) (! (=> (HasType @x4 @x1) (= (ApplyTT @x2 (ApplyTT @x3 @x4)) @x4) ) :qid equation_LowStar.BufferView.inverses.2)) ) ) :pattern ((LowStar.BufferView.inverses @x0 @x1 @x2 @x3)) :qid equation_LowStar.BufferView.inverses)) :named equation_LowStar.BufferView.inverses))
...
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Views.get32_def@tok @x0) (Views.get32_def @x0)) :pattern ((ApplyTT Views.get32_def@tok @x0)) :qid token_correspondence_Views.get32_def)) :named token_correspondence_Views.get32_def))
(assert (! (forall ((@x0 Term)) (! (= (Views.get32_def @x0) (FStar.UInt32.uint_to_t (Prims.op_Addition (Prims.op_Addition (Prims.op_Addition (FStar.UInt8.v (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value) @x0 (BoxInt 0))) (Prims.op_Multiply (FStar.UInt8.v (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value) @x0 (BoxInt 1))) (BoxInt 256))) (Prims.op_Multiply (FStar.UInt8.v (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value) @x0 (BoxInt 2))) (BoxInt 65536))) (Prims.op_Multiply (FStar.UInt8.v (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value) @x0 (BoxInt 3))) (BoxInt 16777216))))) :pattern ((Views.get32_def @x0)) :qid equation_Views.get32_def)) :named equation_Views.get32_def))
(declare-fun Views.put32_def (Term) Term)
(declare-fun Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d () Term)
(assert (! (forall ((@x0 Term)) (! (= (HasTypeZ @x0 Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d) (forall ((@x1 Term)) (! (=> (HasType @x1 (FStar.UInt32.t Dummy_value)) (HasType (ApplyTT @x0 @x1) (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4)))) :pattern ((ApplyTT @x0 @x1)) :qid Views_interpretation_Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d.1)) ) :pattern ((HasTypeZ @x0 Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d)) :qid Views_interpretation_Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d)) :named Views_interpretation_Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d))
(declare-fun Views.put32_def@tok () Term)
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Views.put32_def@tok @x0) (Views.put32_def @x0)) :pattern ((ApplyTT Views.put32_def@tok @x0)) :qid token_correspondence_Views.put32_def)) :named token_correspondence_Views.put32_def))
(assert (! (forall ((@x0 Term)) (! (= (Views.put32_def @x0) (FStar.Seq.Base.upd (FStar.UInt8.t Dummy_value) (FStar.Seq.Base.upd (FStar.UInt8.t Dummy_value) (FStar.Seq.Base.upd (FStar.UInt8.t Dummy_value) (FStar.Seq.Base.upd (FStar.UInt8.t Dummy_value) (FStar.Seq.Base.create (FStar.UInt8.t Dummy_value) (BoxInt 4) (FStar.UInt8.uint_to_t (BoxInt 0))) (BoxInt 0) (FStar.UInt8.uint_to_t (Prims.op_Modulus (FStar.UInt32.v @x0) (BoxInt 256)))) (BoxInt 1) (FStar.UInt8.uint_to_t (Prims.op_Modulus (Prims.op_Division (FStar.UInt32.v @x0) (BoxInt 256)) (BoxInt 256)))) (BoxInt 2) (FStar.UInt8.uint_to_t (Prims.op_Modulus (Prims.op_Division (Prims.op_Division (FStar.UInt32.v @x0) (BoxInt 256)) (BoxInt 256)) (BoxInt 256)))) (BoxInt 3) (FStar.UInt8.uint_to_t (Prims.op_Modulus (Prims.op_Division (Prims.op_Division (Prims.op_Division (FStar.UInt32.v @x0) (BoxInt 256)) (BoxInt 256)) (BoxInt 256)) (BoxInt 256))))) :pattern ((Views.put32_def @x0)) :qid equation_Views.put32_def)) :named equation_Views.put32_def))
(declare-fun Views.get32 (Term) Term)
(declare-fun Views.get32@tok () Term)
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Views.get32@tok @x0) (Views.get32 @x0)) :pattern ((ApplyTT Views.get32@tok @x0)) :qid token_correspondence_Views.get32)) :named token_correspondence_Views.get32))
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4))) (HasType (Views.get32 @x0) (FStar.UInt32.t Dummy_value))) :pattern ((Views.get32 @x0)) :qid typing_Views.get32)) :named typing_Views.get32))
(assert (! (Valid (ApplyTT __uu__PartialApp Views.get32_def@tok)) :named kick_partial_app_88c9653d4f2c168f0aaca9dda4cd9c62))
(assert (! (forall ((@x0 Term)) (! (= (Views.get32 @x0) (ApplyTT (ApplyTT (ApplyTT Opaque_s.make_opaque@tok Tm_arrow_c81b6cfca2035d9dff9ed9f0160ef2ef) Views.get32_def@tok) @x0)) :pattern ((Views.get32 @x0)) :qid equation_Views.get32)) :named equation_Views.get32))
(declare-fun Views.put32 (Term) Term)
(declare-fun Views.put32@tok () Term)
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Views.put32@tok @x0) (Views.put32 @x0)) :pattern ((ApplyTT Views.put32@tok @x0)) :qid token_correspondence_Views.put32)) :named token_correspondence_Views.put32))
(assert (! (forall ((@x0 Term)) (! (and (NoHoist @x0 (HasType Views.put32@tok Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d)) (forall ((@x1 Term)) (! (= (ApplyTT Views.put32@tok @x1) (Views.put32 @x1)) :pattern ((Views.put32 @x1)) :qid function_token_typing_Views.put32.1)) ) :pattern ((ApplyTT @x0 Views.put32@tok)) :qid function_token_typing_Views.put32)) :named function_token_typing_Views.put32))
(assert (! (forall ((@x0 Term)) (! (=> (HasType @x0 (FStar.UInt32.t Dummy_value)) (HasType (Views.put32 @x0) (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4)))) :pattern ((Views.put32 @x0)) :qid typing_Views.put32)) :named typing_Views.put32))
(assert (! (Valid (ApplyTT __uu__PartialApp Views.put32_def@tok)) :named kick_partial_app_e8f5d0e6b1e43655fb71e0183b29c282))
(assert (! (forall ((@x0 Term)) (! (= (Views.put32 @x0) (ApplyTT (ApplyTT (ApplyTT Opaque_s.make_opaque@tok Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d) Views.put32_def@tok) @x0)) :pattern ((Views.put32 @x0)) :qid equation_Views.put32)) :named equation_Views.put32))
(push)
...
(declare-fun Tm_refine_7ad93079cfdb9570abbe5f941dabafbe (Term) Term)
(declare-fun Tm_arrow_6fb568c91d27e4d83626e2826d87703b () Term)
...
(assert (! (not (forall ((@x0 Term)) (! (=> (HasType @x0 Prims.unit) (forall ((@x1 Term)) (! (=> (and (HasType @x1 (Prims.pure_post Prims.unit)) (forall ((@x2 Term)) (! (=> (and (or label_39 (HasType @x2 Prims.unit)) (or label_40 (Valid (LowStar.BufferView.inverses (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4)) (FStar.UInt32.t Dummy_value) Views.get32@tok Views.put32@tok) ) ) ) (Valid (ApplyTT @x1 @x2) ) ) :pattern ( (Valid (ApplyTT @x1 @x2) ) ) :qid @query.2)) ) (forall ((@x2 Term)) (! (=> (and (HasType @x2 Prims.unit) (= Views.get32_def@tok (Opaque_s.make_opaque Tm_arrow_c81b6cfca2035d9dff9ed9f0160ef2ef Views.get32_def@tok)) ) (forall ((@x3 Term)) (! (=> (and (HasType @x3 Prims.unit) (= Views.put32_def@tok (Opaque_s.make_opaque Tm_ghost_arrow_3037292cd3a0ee378442aefecb9f128d Views.put32_def@tok)) ) (and (forall ((@x4 Term)) (! (=> (HasType @x4 (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4))) (forall ((@x5 Term)) (! (=> (and (HasType @x5 (Prims.pure_post Prims.unit)) (forall ((@x6 Term)) (! (=> (and (or label_41 (HasType @x6 Prims.unit)) (or label_42 (= (Views.put32 (Views.get32 @x4)) @x4) ) ) (Valid (ApplyTT @x5 @x6) ) ) :pattern ( (Valid (ApplyTT @x5 @x6) ) ) :qid @query.7)) ) (and (or label_43 (Valid (FStar.Seq.Base.equal (FStar.UInt8.t Dummy_value) @x4 (Views.put32 (Views.get32 @x4))) ) ) (forall ((@x6 Term)) (! (=> (and (HasType @x6 Prims.unit) (Valid (FStar.Seq.Base.equal (FStar.UInt8.t Dummy_value) @x4 (Views.put32 (Views.get32 @x4))) ) ) (Valid (ApplyTT @x5 @x6) ) ) :qid @query.8)) ) ) :qid @query.6)) ) :qid @query.5)) (forall ((@x4 Term)) (! (=> (HasType @x4 Tm_arrow_6fb568c91d27e4d83626e2826d87703b) (forall ((@x5 Term)) (! (=> (and (HasType @x5 Prims.unit) (forall ((@x6 Term)) (! (=> (HasType @x6 (FStar.Seq.Properties.lseq (FStar.UInt8.t Dummy_value) (BoxInt 4))) (= (Views.put32 (Views.get32 @x6)) @x6) ) :qid @query.11)) ) (Valid (ApplyTT @x1 @x5) ) ) :qid @query.10)) ) :qid @query.9)) ) ) :qid @query.4)) ) :qid @query.3)) ) :qid @query.1)) ) :qid @query))) :named query))
(check-sat)
