...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Prims.op_AmpAmp @x0 @x1) (BoxBool (and (BoxBool_proj_0 @x0) (BoxBool_proj_0 @x1)))) :pattern ((Prims.op_AmpAmp @x0 @x1)) :qid primitive_Prims.op_AmpAmp)) :named primitive_Prims.op_AmpAmp))
(declare-fun Prims.op_BarBar (Term Term) Term)
(declare-fun Prims.op_BarBar@tok () Term)
(declare-fun Prims.op_Negation (Term) Term)
(declare-fun Prims.op_Negation@tok () Term)
(assert (! (forall ((@x0 Term)) (! (= (Prims.op_Negation @x0) (BoxBool (not (BoxBool_proj_0 @x0)))) :pattern ((Prims.op_Negation @x0)) :qid primitive_Prims.op_Negation)) :named primitive_Prims.op_Negation))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Valid (Prims.hasEq (Tm_refine_fecdd2ae53c0a93957b26207869967fb @x0 @x1))) (Valid (Prims.hasEq (Prims.list @x0)))) :pattern ((Valid (Prims.hasEq (Tm_refine_fecdd2ae53c0a93957b26207869967fb @x0 @x1)))) :qid haseqTm_refine_fecdd2ae53c0a93957b26207869967fb)) :named haseqTm_refine_fecdd2ae53c0a93957b26207869967fb))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0) (HasType @x3 (Common.OrdSet.ordset @x0 @x1))) (HasType (Common.OrdSet.mem @x0 @x1 @x2 @x3) Prims.bool)) :pattern ((Common.OrdSet.mem @x0 @x1 @x2 @x3)) :qid typing_Common.OrdSet.mem)) :named typing_Common.OrdSet.mem))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Common.OrdSet.intersect@tok @x0) @x1) @x2) @x3) (Common.OrdSet.intersect @x0 @x1 @x2 @x3)) :pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Common.OrdSet.intersect@tok @x0) @x1) @x2) @x3)) :qid token_correspondence_Common.OrdSet.intersect)) :named token_correspondence_Common.OrdSet.intersect))
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (=> (and (HasType @x1 Prims.eqtype) (HasType @x2 (Common.OrdSet.cmp @x1)) (HasType @x3 (Common.OrdSet.ordset @x1 @x2)) (HasType @x4 (Common.OrdSet.ordset @x1 @x2))) (= (Common.OrdSet.intersect.fuel_instrumented (SFuel @u0) @x1 @x2 @x3 @x4) (let ((@lb5 @x3)) (ite (is-Prims.Nil @lb5) (Prims.Nil @x1) (ite (is-Prims.Cons @lb5) (let ((@lb6 (Common.OrdSet.mem @x1 @x2 (Prims.Cons_hd @lb5) @x4))) (ite (= @lb6 (BoxBool true)) (Common.OrdSet.insert_ @x1 @x2 (Prims.Cons_hd @lb5) (Common.OrdSet.intersect.fuel_instrumented @u0 @x1 @x2 (Prims.Cons_tl @lb5) @x4)) (Common.OrdSet.intersect.fuel_instrumented @u0 @x1 @x2 (Prims.Cons_tl @lb5) @x4))) Tm_unit))))) :weight 0 :pattern ((Common.OrdSet.intersect.fuel_instrumented (SFuel @u0) @x1 @x2 @x3 @x4)) :qid equation_with_fuel_Common.OrdSet.intersect.fuel_instrumented)) :named equation_with_fuel_Common.OrdSet.intersect.fuel_instrumented))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (=> (and (HasType @x1 Prims.eqtype) (HasType @x2 (Common.OrdSet.cmp @x1)) (HasType @x3 @x1) (HasType @x4 (Common.OrdSet.ordset @x1 @x2))) (= (Common.OrdSet.remove_.fuel_instrumented (SFuel @u0) @x1 @x2 @x3 @x4) (let ((@lb5 @x4)) (ite (is-Prims.Nil @lb5) (Prims.Nil @x1) (ite (is-Prims.Cons @lb5) (let ((@lb6 (Prims.op_Equality @x1 @x3 (Prims.Cons_hd @lb5)))) (ite (= @lb6 (BoxBool true)) (Prims.Cons_tl @lb5) (Prims.Cons @x1 (Prims.Cons_hd @lb5) (Common.OrdSet.remove_.fuel_instrumented @u0 @x1 @x2 @x3 (Prims.Cons_tl @lb5))))) Tm_unit))))) :weight 0 :pattern ((Common.OrdSet.remove_.fuel_instrumented (SFuel @u0) @x1 @x2 @x3 @x4)) :qid equation_with_fuel_Common.OrdSet.remove_.fuel_instrumented)) :named equation_with_fuel_Common.OrdSet.remove_.fuel_instrumented))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0) (HasType @x3 (Common.OrdSet.ordset @x0 @x1))) (HasType (Common.OrdSet.remove @x0 @x1 @x2 @x3) (Common.OrdSet.ordset @x0 @x1))) :pattern ((Common.OrdSet.remove @x0 @x1 @x2 @x3)) :qid typing_Common.OrdSet.remove)) :named typing_Common.OrdSet.remove))
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (Common.OrdSet.remove @x0 @x1 @x2 @x3) (Common.OrdSet.remove_ @x0 @x1 @x2 @x3)) :pattern ((Common.OrdSet.remove @x0 @x1 @x2 @x3)) :qid equation_Common.OrdSet.remove)) :named equation_Common.OrdSet.remove))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (= (Valid (Common.OrdSet.equal @x0 @x1 @x2 @x3)) (forall ((@x4 Term)) (! (=> (HasType @x4 @x0) (= (Common.OrdSet.mem @x0 @x1 @x4 @x2) (Common.OrdSet.mem @x0 @x1 @x4 @x3)) ) :qid equation_Common.OrdSet.equal.1)) ) :pattern ((Common.OrdSet.equal @x0 @x1 @x2 @x3)) :qid equation_Common.OrdSet.equal)) :named equation_Common.OrdSet.equal))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 (Common.OrdSet.ordset @x0 @x1)) (HasType @x3 (Common.OrdSet.ordset @x0 @x1)) (Valid (Common.OrdSet.equal @x0 @x1 @x2 @x3) ) ) (= @x2 @x3) ) :pattern ((Common.OrdSet.equal @x0 @x1 @x2 @x3)) :qid lemma_Common.OrdSet.eq_lemma)) :named lemma_Common.OrdSet.eq_lemma))
(declare-fun Common.OrdSet.mem_empty (Term Term Term) Term)
(declare-fun Common.OrdSet.mem_empty@tok () Term)
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0)) (not (BoxBool_proj_0 (Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.empty @x0 @x1))))) :pattern ((Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.empty @x0 @x1))) :qid lemma_Common.OrdSet.mem_empty)) :named lemma_Common.OrdSet.mem_empty))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0) (HasType @x3 (Common.OrdSet.ordset @x0 @x1)) (HasType @x4 (Common.OrdSet.ordset @x0 @x1))) (= (Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x3 @x4)) (Prims.op_AmpAmp (Common.OrdSet.mem @x0 @x1 @x2 @x3) (Common.OrdSet.mem @x0 @x1 @x2 @x4))) ) :pattern ((Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x3 @x4))) :qid lemma_Common.OrdSet.mem_intersect)) :named lemma_Common.OrdSet.mem_intersect))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 (Common.OrdSet.ordset @x0 @x1)) (HasType @x3 (Common.OrdSet.ordset @x0 @x1))) (= (BoxBool_proj_0 (Common.OrdSet.subset.fuel_instrumented ZFuel @x0 @x1 @x2 @x3)) (forall ((@x4 Term)) (! (=> (and (HasType @x4 @x0) (BoxBool_proj_0 (Common.OrdSet.mem @x0 @x1 @x4 @x2)) ) (BoxBool_proj_0 (Common.OrdSet.mem @x0 @x1 @x4 @x3)) ) :qid lemma_Common.OrdSet.mem_subset.1)) ) ) :pattern ((Common.OrdSet.subset.fuel_instrumented ZFuel @x0 @x1 @x2 @x3)) :qid lemma_Common.OrdSet.mem_subset)) :named lemma_Common.OrdSet.mem_subset))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0) (HasType @x3 @x0) (HasType @x4 (Common.OrdSet.ordset @x0 @x1))) (= (Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.remove @x0 @x1 @x3 @x4)) (Prims.op_AmpAmp (Common.OrdSet.mem @x0 @x1 @x2 @x4) (Prims.op_Negation (Prims.op_Equality @x0 @x2 @x3)))) ) :pattern ((Common.OrdSet.mem @x0 @x1 @x2 (Common.OrdSet.remove @x0 @x1 @x3 @x4))) :qid lemma_Common.OrdSet.mem_remove)) :named lemma_Common.OrdSet.mem_remove))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 @x0) (HasType @x3 (Common.OrdSet.ordset @x0 @x1)) (BoxBool_proj_0 (Common.OrdSet.mem @x0 @x1 @x2 @x3)) ) (= (Common.OrdSet.size @x0 @x1 @x3) (Prims.op_Addition (Common.OrdSet.size @x0 @x1 (Common.OrdSet.remove @x0 @x1 @x2 @x3)) (BoxInt 1))) ) :pattern ((Common.OrdSet.size @x0 @x1 (Common.OrdSet.remove @x0 @x1 @x2 @x3))) :qid lemma_Common.OrdSet.size_remove)) :named lemma_Common.OrdSet.size_remove))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 (Common.OrdSet.ordset @x0 @x1)) (HasType @x3 (Common.OrdSet.ordset @x0 @x1)) (BoxBool_proj_0 (Common.OrdSet.subset.fuel_instrumented ZFuel @x0 @x1 @x2 @x3)) ) (<= (BoxInt_proj_0 (Common.OrdSet.size @x0 @x1 @x2)) (BoxInt_proj_0 (Common.OrdSet.size @x0 @x1 @x3))) ) :pattern ((Common.OrdSet.subset.fuel_instrumented ZFuel @x0 @x1 @x2 @x3)) :qid lemma_Common.OrdSet.subset_size)) :named lemma_Common.OrdSet.subset_size))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term)) (! (=> (and (HasType @x0 Prims.eqtype) (HasType @x1 (Common.OrdSet.cmp @x0)) (HasType @x2 (Common.OrdSet.ordset @x0 @x1)) (HasType @x3 (Common.OrdSet.ordset @x0 @x1))) (= (Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x2 @x3) (Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x3 @x2)) ) :pattern ((Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x2 @x3)) :pattern ((Common.OrdSet.intersect.fuel_instrumented ZFuel @x0 @x1 @x3 @x2)) :qid lemma_Common.OrdSet.lemma_intersect_symmetric)) :named lemma_Common.OrdSet.lemma_intersect_symmetric))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (HasTypeZ @x0 (Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x1)) (and (forall ((@x2 Term) (@x3 Term)) (! (=> (and (HasType @x2 @x1) (HasType @x3 @x1)) (HasType (ApplyTT (ApplyTT @x0 @x2) @x3) @x1)) :pattern ((ApplyTT (ApplyTT @x0 @x2) @x3)) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.1)) (IsTotFun @x0) (forall ((@x2 Term)) (! (=> (HasType @x2 @x1) (IsTotFun (ApplyTT @x0 @x2))) :pattern ((ApplyTT @x0 @x2)) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.2)) )) :pattern ((HasTypeZ @x0 (Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x1))) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b)) :named Compiler.Common.Dataflow_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
(assert (! (forall ((@x0 Term)) (! (= (Compiler.Common.Dataflow.lat_op_t @x0) (Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x0)) :pattern ((Compiler.Common.Dataflow.lat_op_t @x0)) :qid equation_Compiler.Common.Dataflow.lat_op_t)) :named equation_Compiler.Common.Dataflow.lat_op_t))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term)) (! (= (Compiler.Common.Dataflow.Mklattice_meet (Compiler.Common.Dataflow.Mklattice @x0 @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12)) @x4) :pattern ((Compiler.Common.Dataflow.Mklattice @x0 @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12)) :qid projection_inverse_Compiler.Common.Dataflow.Mklattice_meet)) :named projection_inverse_Compiler.Common.Dataflow.Mklattice_meet))
...
(assert (! (forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term)) (! (=> (HasTypeFuel (SFuel @u0) (Compiler.Common.Dataflow.Mklattice @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12 @x13) Compiler.Common.Dataflow.lattice) (and (HasTypeFuel @u0 @x1 Prims.eqtype) (HasTypeFuel @u0 @x2 @x1) (HasTypeFuel @u0 @x3 @x1) (HasTypeFuel @u0 @x4 (Compiler.Common.Dataflow.lat_op_t @x1)) (HasTypeFuel @u0 @x5 (Compiler.Common.Dataflow.lat_op_t @x1)) (HasTypeFuel @u0 @x6 (Compiler.Common.Dataflow.lat_comm_t @x1 @x4)) (HasTypeFuel @u0 @x7 (Compiler.Common.Dataflow.lat_comm_t @x1 @x5)) (HasTypeFuel @u0 @x8 (Compiler.Common.Dataflow.lat_assoc_t @x1 @x4)) (HasTypeFuel @u0 @x9 (Compiler.Common.Dataflow.lat_assoc_t @x1 @x5)) (HasTypeFuel @u0 @x10 (Compiler.Common.Dataflow.lat_absorb_t @x1 @x4 @x5)) (HasTypeFuel @u0 @x11 (Compiler.Common.Dataflow.lat_absorb_t @x1 @x5 @x4)) (HasTypeFuel @u0 @x12 (Compiler.Common.Dataflow.lat_ident_t @x1 @x4 @x2)) (HasTypeFuel @u0 @x13 (Compiler.Common.Dataflow.lat_ident_t @x1 @x5 @x3)))) :pattern ((HasTypeFuel (SFuel @u0) (Compiler.Common.Dataflow.Mklattice @x1 @x2 @x3 @x4 @x5 @x6 @x7 @x8 @x9 @x10 @x11 @x12 @x13) Compiler.Common.Dataflow.lattice)) :qid data_elim_Compiler.Common.Dataflow.Mklattice)) :named data_elim_Compiler.Common.Dataflow.Mklattice))
...
(assert (! (forall ((@x0 Term)) (! (= (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__meet@tok @x0) (Compiler.Common.Dataflow.__proj__Mklattice__item__meet @x0)) :pattern ((ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__meet@tok @x0)) :qid token_correspondence_Compiler.Common.Dataflow.__proj__Mklattice__item__meet)) :named token_correspondence_Compiler.Common.Dataflow.__proj__Mklattice__item__meet))
(assert (! (forall ((@x0 Term)) (! (= (Compiler.Common.Dataflow.__proj__Mklattice__item__meet @x0) (Compiler.Common.Dataflow.Mklattice_meet @x0)) :pattern ((Compiler.Common.Dataflow.__proj__Mklattice__item__meet @x0)) :qid proj_equation_Compiler.Common.Dataflow.Mklattice_meet)) :named proj_equation_Compiler.Common.Dataflow.Mklattice_meet))
...
(assert (! (forall ((@x0 Term)) (! (and (NoHoist @x0 (HasType Compiler.Common.Dataflow.meet@tok Tm_arrow_acb49ebf487aed42043dcd606156323f)) (forall ((@x1 Term)) (! (= (ApplyTT Compiler.Common.Dataflow.meet@tok @x1) (Compiler.Common.Dataflow.meet @x1)) :pattern ((Compiler.Common.Dataflow.meet @x1)) :qid function_token_typing_Compiler.Common.Dataflow.meet.1)) ) :pattern ((ApplyTT @x0 Compiler.Common.Dataflow.meet@tok)) :qid function_token_typing_Compiler.Common.Dataflow.meet)) :named function_token_typing_Compiler.Common.Dataflow.meet))
...
(assert (! (forall ((@x0 Term)) (! (= (Compiler.Common.Dataflow.meet @x0) (ApplyTT (ApplyTT Common.OrdSet.intersect@tok (Compiler.Common.Dataflow.pc_ @x0)) Prims.op_LessThanOrEqual@tok)) :pattern ((Compiler.Common.Dataflow.meet @x0)) :qid equation_Compiler.Common.Dataflow.meet)) :named equation_Compiler.Common.Dataflow.meet))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Compiler.Common.Dataflow.size_ @x0 @x1) (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x1)) :pattern ((Compiler.Common.Dataflow.size_ @x0 @x1)) :qid equation_Compiler.Common.Dataflow.size_)) :named equation_Compiler.Common.Dataflow.size_))
...
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (= (Compiler.Common.Dataflow.mem_ @x0 @x1 @x2) (Common.OrdSet.mem (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x1 @x2)) :pattern ((Compiler.Common.Dataflow.mem_ @x0 @x1 @x2)) :qid equation_Compiler.Common.Dataflow.mem_)) :named equation_Compiler.Common.Dataflow.mem_))
...
(assert (! (forall ((@x0 Term) (@x1 Term)) (! (= (Compiler.Common.Dataflow.m @x0 @x1) (Compiler.Common.Dataflow.size_ @x0 @x1)) :pattern ((Compiler.Common.Dataflow.m @x0 @x1)) :qid equation_Compiler.Common.Dataflow.m)) :named equation_Compiler.Common.Dataflow.m))
...
(push)
(declare-fun label_134 () Bool)
(declare-fun label_133 () Bool)
(declare-fun label_132 () Bool)
(declare-fun label_131 () Bool)
(declare-fun label_130 () Bool)
(declare-fun label_129 () Bool)
(declare-fun label_128 () Bool)
(declare-fun label_127 () Bool)
(declare-fun label_126 () Bool)
(declare-fun label_125 () Bool)
(declare-fun label_124 () Bool)
(declare-fun label_123 () Bool)
(declare-fun label_122 () Bool)
(declare-fun label_121 () Bool)
(declare-fun label_120 () Bool)
(declare-fun label_119 () Bool)
(declare-fun label_118 () Bool)
(declare-fun Tm_refine_11cb5aa77eeb041d795a47bfb7099977 (Term) Term)
(declare-fun Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056 () Term)
(assert (! (forall ((@x0 Term)) (! (= (HasTypeZ @x0 Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056) (and (forall ((@x1 Term) (@x2 Term)) (! (=> (and (HasType @x1 Prims.int) (HasType @x2 Prims.int)) (HasType (ApplyTT (ApplyTT @x0 @x1) @x2) Prims.bool)) :pattern ((ApplyTT (ApplyTT @x0 @x1) @x2)) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056.1)) (IsTotFun @x0) (forall ((@x1 Term)) (! (=> (HasType @x1 Prims.int) (IsTotFun (ApplyTT @x0 @x1))) :pattern ((ApplyTT @x0 @x1)) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056.2)) )) :pattern ((HasTypeZ @x0 Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056)) :qid Compiler.Common.Dataflow_interpretation_Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056)) :named Compiler.Common.Dataflow_interpretation_Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056))
(declare-fun Tm_arrow_50a0b923e61f82a4752ac8c93c575dec (Term) Term)
(declare-fun Tm_abs_f1378ceee84a0168cb47f63281896e7b (Term Term Term) Term)
(push)
(assert (! (= MaxFuel (SFuel ZFuel)) :named MaxFuel_assumption))
(assert (! (= MaxIFuel (SFuel ZFuel)) :named MaxIFuel_assumption))
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term)) (! (=> (and (HasType @x0 (I1.Semantics.cfg Dummy_value)) (HasType @x1 (Compiler.Common.Dataflow.__proj__Mklattice__item__t (Compiler.Common.Dataflow.l @x0))) (HasType @x2 (Compiler.Common.Dataflow.__proj__Mklattice__item__t (Compiler.Common.Dataflow.l @x0)))) (forall ((@x3 Term)) (! (=> (and (HasType @x3 (Prims.pure_post Prims.unit)) (forall ((@x4 Term)) (! (=> (and (or label_118 (HasType @x4 Prims.unit)) (=> (not (= (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__meet@tok (Compiler.Common.Dataflow.l @x0)) @x1) @x2) @x1)) (or label_119 (< (BoxInt_proj_0 (Compiler.Common.Dataflow.m @x0 (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.__proj__Mklattice__item__meet@tok (Compiler.Common.Dataflow.l @x0)) @x1) @x2))) (BoxInt_proj_0 (Compiler.Common.Dataflow.m @x0 @x1))) ) )) (Valid (ApplyTT @x3 @x4) ) ) :pattern ( (Valid (ApplyTT @x3 @x4) ) ) :qid @query.2)) ) (and (or label_120 (Valid (Prims.hasEq (Prims.list (Compiler.Common.Dataflow.pc_ @x0))) ) ) (forall ((@x4 Term)) (! (=> (HasType @x4 (Prims.list (Compiler.Common.Dataflow.pc_ @x0))) (and (or label_121 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (=> (not (BoxBool_proj_0 (Common.OrdSet.sorted (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x4)) ) (or label_122 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) )) ) :qid @query.3)) (forall ((@x4 Term)) (! (=> (and (HasType @x4 Tm_type) (= (Tm_refine_11cb5aa77eeb041d795a47bfb7099977 @x0) @x4) ) (and (or label_123 (BoxBool_proj_0 (Common.OrdSet.sorted (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2))) (BoxBool_proj_0 (Common.OrdSet.sorted (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2))) ) (forall ((@x5 Term)) (! (=> (and (HasType @x5 (Compiler.Common.Dataflow.t @x0)) (= (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x5) ) (and (or label_124 (BoxBool_proj_0 (Common.OrdSet.sorted (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x1)) (BoxBool_proj_0 (Common.OrdSet.sorted (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x1)) ) (forall ((@x6 Term)) (! (=> (and (HasType @x6 (Compiler.Common.Dataflow.__proj__Mklattice__item__t (Compiler.Common.Dataflow.l @x0))) (= @x1 @x6) ) (forall ((@x7 Term)) (! (=> (and (HasType @x7 Prims.bool) (= (Prims.op_Equality (Tm_refine_11cb5aa77eeb041d795a47bfb7099977 @x0) (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) @x7) ) (forall ((@x8 Term)) (! (=> (and (HasType @x8 (Prims.pure_post Prims.unit)) (forall ((@x9 Term)) (! (=> (Valid (ApplyTT @x3 @x9) ) (Valid (ApplyTT @x8 @x9) ) ) :weight 0 :pattern ((ApplyTT @x8 @x9)) :qid @query.9)) ) (and (=> (= (Prims.op_Equality (Tm_refine_11cb5aa77eeb041d795a47bfb7099977 @x0) (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) (BoxBool true)) (forall ((@x9 Term)) (! (=> (HasType @x9 Prims.unit) (Valid (ApplyTT @x8 @x9) ) ) :qid @query.10)) ) (=> (not (= (Prims.op_Equality (Tm_refine_11cb5aa77eeb041d795a47bfb7099977 @x0) (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) (BoxBool true)) ) (forall ((@x9 Term)) (! (=> (and (HasType @x9 Prims.bool) (= (Prims.op_Equality (Tm_refine_11cb5aa77eeb041d795a47bfb7099977 @x0) (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) @x9) ) (and (or label_125 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (forall ((@x10 Term)) (! (=> (and (HasType @x10 Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056) (= Prims.op_LessThanOrEqual@tok @x10) ) (forall ((@x11 Term)) (! (=> (and (HasType @x11 Prims.logical) (= (Common.OrdSet.equal (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) @x11) ) (forall ((@x12 Term)) (! (=> (and (HasType @x12 Prims.logical) (= (Prims.l_not (Common.OrdSet.equal (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1)) @x12) ) (and (or label_126 (not (Valid (Common.OrdSet.equal (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) ) ) ) (forall ((@x13 Term)) (! (=> (and (HasType @x13 Prims.unit) (not (Valid (Common.OrdSet.equal (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) @x1) ) ) ) (and (forall ((@x14 Term)) (! (=> (HasType @x14 (Compiler.Common.Dataflow.pc_ @x0)) (and (=> (BoxBool_proj_0 (Compiler.Common.Dataflow.mem_ @x0 @x14 @x1)) (or label_127 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) ) (=> (and (BoxBool_proj_0 (Compiler.Common.Dataflow.mem_ @x0 @x14 @x1)) (not (BoxBool_proj_0 (Common.OrdSet.mem (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2))))) (and (or label_128 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (or label_129 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (forall ((@x15 Term)) (! (=> (and (HasType @x15 Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056) (= Prims.op_LessThanOrEqual@tok @x15) ) (forall ((@x16 Term)) (! (=> (and (HasType @x16 (Common.OrdSet.ordset (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok)) (= (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1) @x16) ) (and (or label_130 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (=> (= (Compiler.Common.Dataflow.size_ @x0 @x1) (Prims.op_Addition (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1)) (BoxInt 1))) (or label_131 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) ) (=> (and (= (Compiler.Common.Dataflow.size_ @x0 @x1) (Prims.op_Addition (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1)) (BoxInt 1))) (BoxBool_proj_0 (Common.OrdSet.subset (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1))) ) (and (or label_132 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) (forall ((@x17 Term)) (! (=> (and (HasType @x17 Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056) (= Prims.op_LessThanOrEqual@tok @x17) ) (forall ((@x18 Term)) (! (=> (and (HasType @x18 Prims.nat) (= (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1)) @x18) ) (forall ((@x19 Term)) (! (=> (and (HasType @x19 Prims.nat) (= @x19 (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1))) (= (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x14 @x1)) @x19) ) (or label_133 (Valid (Common.OrdSet.total_order (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok) ) ) ) :qid @query.21)) ) :qid @query.20)) ) :qid @query.19)) ) )) ) :qid @query.18)) ) :qid @query.17)) ) )) ) :qid @query.16)) (forall ((@x14 Term)) (! (=> (and (HasType @x14 (Tm_arrow_50a0b923e61f82a4752ac8c93c575dec @x0)) (= (Tm_abs_f1378ceee84a0168cb47f63281896e7b @x1 @x2 @x0) @x14) ) (forall ((@x15 Term)) (! (=> (and (HasType @x15 Prims.logical) (= (Prims.l_Exists (Compiler.Common.Dataflow.pc_ @x0) (Tm_abs_f1378ceee84a0168cb47f63281896e7b @x1 @x2 @x0)) @x15) ) (and (or label_134 (exists ((@x16 Term)) (! (and (HasType @x16 (Compiler.Common.Dataflow.pc_ @x0)) (BoxBool_proj_0 (Compiler.Common.Dataflow.mem_ @x0 @x16 @x1)) (not (BoxBool_proj_0 (Common.OrdSet.mem (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x16 (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2)))) (= (Compiler.Common.Dataflow.size_ @x0 @x1) (Prims.op_Addition (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x16 @x1)) (BoxInt 1))) (BoxBool_proj_0 (Common.OrdSet.subset (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x16 @x1))) (>= (BoxInt_proj_0 (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x16 @x1))) (BoxInt_proj_0 (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2)))) ) :qid @query.24)) ) (forall ((@x16 Term)) (! (=> (and (HasType @x16 Prims.unit) (exists ((@x17 Term)) (! (and (HasType @x17 (Compiler.Common.Dataflow.pc_ @x0)) (BoxBool_proj_0 (Compiler.Common.Dataflow.mem_ @x0 @x17 @x1)) (not (BoxBool_proj_0 (Common.OrdSet.mem (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x17 (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2)))) (= (Compiler.Common.Dataflow.size_ @x0 @x1) (Prims.op_Addition (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x17 @x1)) (BoxInt 1))) (BoxBool_proj_0 (Common.OrdSet.subset (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2) (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x17 @x1))) (>= (BoxInt_proj_0 (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (Common.OrdSet.remove (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok @x17 @x1))) (BoxInt_proj_0 (Common.OrdSet.size (Compiler.Common.Dataflow.pc_ @x0) Prims.op_LessThanOrEqual@tok (ApplyTT (ApplyTT (ApplyTT Compiler.Common.Dataflow.meet@tok @x0) @x1) @x2)))) ) :qid @query.26)) ) (Valid (ApplyTT @x8 @x16) ) ) :qid @query.25)) ) ) :qid @query.23)) ) :qid @query.22)) ) ) :qid @query.15)) ) ) :qid @query.14)) ) :qid @query.13)) ) :qid @query.12)) ) ) :qid @query.11)) )) ) :qid @query.8)) ) :qid @query.7)) ) :qid @query.6)) ) ) :qid @query.5)) ) ) :qid @query.4)) ) ) :qid @query.1)) ) :qid @query))) :named query))
(check-sat)
